...
namespace SDL
{
    ...
    struct GUID : GUIDRaw
    {
         ...
         */
        constexpr GUID(const GUIDRaw &gUID = {}) noexcept : GUIDRaw(gUID)
        {
        }
    ...
    inline GUID::GUID(StringParam pchGUID) : GUIDRaw(SDL_StringToGUID(pchGUID))
    {
    }
