...
namespace SDL
{
    ...
    constexpr PackedLayout PACKEDLAYOUT_2101010 = SDL_PACKEDLAYOUT_2101010; ///< 2101010

    constexpr PackedLayout PACKEDLAYOUT_1010102 = SDL_PACKEDLAYOUT_1010102; ///< 1010102
    ...
    class PixelFormat
    {
      ...
      public:
         ...
         */
        constexpr PixelFormat(PixelFormatRaw format = {}) noexcept : m_format(format)
        {
        }
         ...
         *
         * ```c
         * DefinePixelFormat(PIXELTYPE_PACKED32, PACKEDORDER_RGBA, PACKEDLAYOUT_8888, 32, 4)
         * ```
         *
    ...
    constexpr PixelFormat PIXELFORMAT_UNKNOWN = SDL_PIXELFORMAT_UNKNOWN; ///< UNKNOWN

    constexpr PixelFormat PIXELFORMAT_INDEX1LSB = SDL_PIXELFORMAT_INDEX1LSB; ///< INDEX1LSB

    constexpr PixelFormat PIXELFORMAT_INDEX1MSB = SDL_PIXELFORMAT_INDEX1MSB; ///< INDEX1MSB

    constexpr PixelFormat PIXELFORMAT_INDEX2LSB = SDL_PIXELFORMAT_INDEX2LSB; ///< INDEX2LSB

    constexpr PixelFormat PIXELFORMAT_INDEX2MSB = SDL_PIXELFORMAT_INDEX2MSB; ///< INDEX2MSB

    constexpr PixelFormat PIXELFORMAT_INDEX4LSB = SDL_PIXELFORMAT_INDEX4LSB; ///< INDEX4LSB

    constexpr PixelFormat PIXELFORMAT_INDEX4MSB = SDL_PIXELFORMAT_INDEX4MSB; ///< INDEX4MSB
    ...
    constexpr PixelFormat PIXELFORMAT_XRGB4444 = SDL_PIXELFORMAT_XRGB4444; ///< XRGB4444

    constexpr PixelFormat PIXELFORMAT_XBGR4444 = SDL_PIXELFORMAT_XBGR4444; ///< XBGR4444

    constexpr PixelFormat PIXELFORMAT_XRGB1555 = SDL_PIXELFORMAT_XRGB1555; ///< XRGB1555

    constexpr PixelFormat PIXELFORMAT_XBGR1555 = SDL_PIXELFORMAT_XBGR1555; ///< XBGR1555

    constexpr PixelFormat PIXELFORMAT_ARGB4444 = SDL_PIXELFORMAT_ARGB4444; ///< ARGB4444

    constexpr PixelFormat PIXELFORMAT_RGBA4444 = SDL_PIXELFORMAT_RGBA4444; ///< RGBA4444

    constexpr PixelFormat PIXELFORMAT_ABGR4444 = SDL_PIXELFORMAT_ABGR4444; ///< ABGR4444

    constexpr PixelFormat PIXELFORMAT_BGRA4444 = SDL_PIXELFORMAT_BGRA4444; ///< BGRA4444

    constexpr PixelFormat PIXELFORMAT_ARGB1555 = SDL_PIXELFORMAT_ARGB1555; ///< ARGB1555

    constexpr PixelFormat PIXELFORMAT_RGBA5551 = SDL_PIXELFORMAT_RGBA5551; ///< RGBA5551

    constexpr PixelFormat PIXELFORMAT_ABGR1555 = SDL_PIXELFORMAT_ABGR1555; ///< ABGR1555

    constexpr PixelFormat PIXELFORMAT_BGRA5551 = SDL_PIXELFORMAT_BGRA5551; ///< BGRA5551
    ...
    constexpr PixelFormat PIXELFORMAT_XRGB8888 = SDL_PIXELFORMAT_XRGB8888; ///< XRGB8888

    constexpr PixelFormat PIXELFORMAT_RGBX8888 = SDL_PIXELFORMAT_RGBX8888; ///< RGBX8888

    constexpr PixelFormat PIXELFORMAT_XBGR8888 = SDL_PIXELFORMAT_XBGR8888; ///< XBGR8888

    constexpr PixelFormat PIXELFORMAT_BGRX8888 = SDL_PIXELFORMAT_BGRX8888; ///< BGRX8888

    constexpr PixelFormat PIXELFORMAT_ARGB8888 = SDL_PIXELFORMAT_ARGB8888; ///< ARGB8888

    constexpr PixelFormat PIXELFORMAT_RGBA8888 = SDL_PIXELFORMAT_RGBA8888; ///< RGBA8888

    constexpr PixelFormat PIXELFORMAT_ABGR8888 = SDL_PIXELFORMAT_ABGR8888; ///< ABGR8888

    constexpr PixelFormat PIXELFORMAT_BGRA8888 = SDL_PIXELFORMAT_BGRA8888; ///< BGRA8888

    constexpr PixelFormat PIXELFORMAT_XRGB2101010 = SDL_PIXELFORMAT_XRGB2101010; ///< XRGB2101010

    constexpr PixelFormat PIXELFORMAT_XBGR2101010 = SDL_PIXELFORMAT_XBGR2101010; ///< XBGR2101010

    constexpr PixelFormat PIXELFORMAT_ARGB2101010 = SDL_PIXELFORMAT_ARGB2101010; ///< ARGB2101010

    constexpr PixelFormat PIXELFORMAT_ABGR2101010 = SDL_PIXELFORMAT_ABGR2101010; ///< ABGR2101010
    ...
    constexpr PixelFormat PIXELFORMAT_RGB48_FLOAT = SDL_PIXELFORMAT_RGB48_FLOAT; ///< RGB48_FLOAT

    constexpr PixelFormat PIXELFORMAT_BGR48_FLOAT = SDL_PIXELFORMAT_BGR48_FLOAT; ///< BGR48_FLOAT

    constexpr PixelFormat PIXELFORMAT_RGBA64_FLOAT = SDL_PIXELFORMAT_RGBA64_FLOAT; ///< RGBA64_FLOAT

    constexpr PixelFormat PIXELFORMAT_ARGB64_FLOAT = SDL_PIXELFORMAT_ARGB64_FLOAT; ///< ARGB64_FLOAT

    constexpr PixelFormat PIXELFORMAT_BGRA64_FLOAT = SDL_PIXELFORMAT_BGRA64_FLOAT; ///< BGRA64_FLOAT

    constexpr PixelFormat PIXELFORMAT_ABGR64_FLOAT = SDL_PIXELFORMAT_ABGR64_FLOAT; ///< ABGR64_FLOAT

    constexpr PixelFormat PIXELFORMAT_RGB96_FLOAT = SDL_PIXELFORMAT_RGB96_FLOAT; ///< RGB96_FLOAT

    constexpr PixelFormat PIXELFORMAT_BGR96_FLOAT = SDL_PIXELFORMAT_BGR96_FLOAT; ///< BGR96_FLOAT

    constexpr PixelFormat PIXELFORMAT_RGBA128_FLOAT = SDL_PIXELFORMAT_RGBA128_FLOAT; ///< RGBA128_FLOAT

    constexpr PixelFormat PIXELFORMAT_ARGB128_FLOAT = SDL_PIXELFORMAT_ARGB128_FLOAT; ///< ARGB128_FLOAT

    constexpr PixelFormat PIXELFORMAT_BGRA128_FLOAT = SDL_PIXELFORMAT_BGRA128_FLOAT; ///< BGRA128_FLOAT

    constexpr PixelFormat PIXELFORMAT_ABGR128_FLOAT = SDL_PIXELFORMAT_ABGR128_FLOAT; ///< ABGR128_FLOAT

    constexpr PixelFormat PIXELFORMAT_YV12 = SDL_PIXELFORMAT_YV12; ///< Planar mode: Y + V + U (3 planes)

    constexpr PixelFormat PIXELFORMAT_IYUV = SDL_PIXELFORMAT_IYUV; ///< Planar mode: Y + U + V (3 planes)

    constexpr PixelFormat PIXELFORMAT_YUY2 = SDL_PIXELFORMAT_YUY2; ///< Packed mode: Y0+U0+Y1+V0 (1 plane)

    constexpr PixelFormat PIXELFORMAT_UYVY = SDL_PIXELFORMAT_UYVY; ///< Packed mode: U0+Y0+V0+Y1 (1 plane)

    constexpr PixelFormat PIXELFORMAT_YVYU = SDL_PIXELFORMAT_YVYU; ///< Packed mode: Y0+V0+Y1+U0 (1 plane)

    constexpr PixelFormat PIXELFORMAT_NV12 = SDL_PIXELFORMAT_NV12; ///< Planar mode: Y + U/V interleaved (2 planes)

    constexpr PixelFormat PIXELFORMAT_NV21 = SDL_PIXELFORMAT_NV21; ///< Planar mode: Y + V/U interleaved (2 planes)

    constexpr PixelFormat PIXELFORMAT_P010 = SDL_PIXELFORMAT_P010; ///< Planar mode: Y + U/V interleaved (2 planes)

    constexpr PixelFormat PIXELFORMAT_EXTERNAL_OES = SDL_PIXELFORMAT_EXTERNAL_OES; ///< Android video texture format
    ...
    constexpr PixelFormat::PixelFormat(PixelType type, int order, PackedLayout layout, int bits, int bytes)
    ...
    constexpr ColorType COLOR_TYPE_UNKNOWN = SDL_COLOR_TYPE_UNKNOWN; ///< COLOR_TYPE_UNKNOWN

    constexpr ColorType COLOR_TYPE_RGB = SDL_COLOR_TYPE_RGB; ///< COLOR_TYPE_RGB

    constexpr ColorType COLOR_TYPE_YCBCR = SDL_COLOR_TYPE_YCBCR; ///< COLOR_TYPE_YCBCR
    ...
    constexpr ColorRange COLOR_RANGE_UNKNOWN = SDL_COLOR_RANGE_UNKNOWN; ///< COLOR_RANGE_UNKNOWN
    ...
    constexpr ColorPrimaries COLOR_PRIMARIES_UNKNOWN = SDL_COLOR_PRIMARIES_UNKNOWN; ///< COLOR_PRIMARIES_UNKNOWN

    constexpr ColorPrimaries COLOR_PRIMARIES_BT709 = SDL_COLOR_PRIMARIES_BT709; ///< ITU-R BT.709-6

    constexpr ColorPrimaries COLOR_PRIMARIES_UNSPECIFIED =
        SDL_COLOR_PRIMARIES_UNSPECIFIED; ///< COLOR_PRIMARIES_UNSPECIFIED

    constexpr ColorPrimaries COLOR_PRIMARIES_BT470M = SDL_COLOR_PRIMARIES_BT470M; ///< ITU-R BT.470-6 System M

    constexpr ColorPrimaries COLOR_PRIMARIES_BT470BG =
        SDL_COLOR_PRIMARIES_BT470BG; ///< ITU-R BT.470-6 System B, G / ITU-R BT.601-7 625

    constexpr ColorPrimaries COLOR_PRIMARIES_BT601 = SDL_COLOR_PRIMARIES_BT601; ///< ITU-R BT.601-7 525, SMPTE 170M

    /// SMPTE 240M, functionally the same as COLOR_PRIMARIES_BT601
    constexpr ColorPrimaries COLOR_PRIMARIES_SMPTE240 = SDL_COLOR_PRIMARIES_SMPTE240;

    constexpr ColorPrimaries COLOR_PRIMARIES_GENERIC_FILM =
        SDL_COLOR_PRIMARIES_GENERIC_FILM; ///< Generic film (color filters using Illuminant C)

    constexpr ColorPrimaries COLOR_PRIMARIES_BT2020 = SDL_COLOR_PRIMARIES_BT2020; ///< ITU-R BT.2020-2 / ITU-R BT.2100-0

    constexpr ColorPrimaries COLOR_PRIMARIES_XYZ = SDL_COLOR_PRIMARIES_XYZ; ///< SMPTE ST 428-1

    constexpr ColorPrimaries COLOR_PRIMARIES_SMPTE431 = SDL_COLOR_PRIMARIES_SMPTE431; ///< SMPTE RP 431-2

    constexpr ColorPrimaries COLOR_PRIMARIES_SMPTE432 = SDL_COLOR_PRIMARIES_SMPTE432; ///< SMPTE EG 432-1 / DCI P3

    constexpr ColorPrimaries COLOR_PRIMARIES_EBU3213 = SDL_COLOR_PRIMARIES_EBU3213; ///< EBU Tech. 3213-E

    constexpr ColorPrimaries COLOR_PRIMARIES_CUSTOM = SDL_COLOR_PRIMARIES_CUSTOM; ///< COLOR_PRIMARIES_CUSTOM
    ...
    constexpr TransferCharacteristics TRANSFER_CHARACTERISTICS_GAMMA22 = SDL_TRANSFER_CHARACTERISTICS_GAMMA22;
    ...
    constexpr TransferCharacteristics TRANSFER_CHARACTERISTICS_BT601 =
        SDL_TRANSFER_CHARACTERISTICS_BT601; ///< SMPTE ST 170M / ITU-R BT.601-7 525 or 625
    ...
    constexpr TransferCharacteristics TRANSFER_CHARACTERISTICS_PQ =
        SDL_TRANSFER_CHARACTERISTICS_PQ; ///< SMPTE ST 2084 for 10-, 12-, 14- and 16-bit systems
    ...
    constexpr TransferCharacteristics TRANSFER_CHARACTERISTICS_HLG =
        SDL_TRANSFER_CHARACTERISTICS_HLG; ///< ARIB STD-B67, known as "hybrid log-gamma" (HLG)
    ...
    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_BT709 = SDL_MATRIX_COEFFICIENTS_BT709; ///< ITU-R BT.709-6
    ...
    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_FCC = SDL_MATRIX_COEFFICIENTS_FCC; ///< US FCC Title 47

    /**
     * ITU-R BT.470-6 System B, G / ITU-R BT.601-7 625, functionally the same as
     * MATRIX_COEFFICIENTS_BT601
     */
    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_BT470BG = SDL_MATRIX_COEFFICIENTS_BT470BG;

    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_BT601 = SDL_MATRIX_COEFFICIENTS_BT601; ///< ITU-R BT.601-7 525

    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_SMPTE240 = SDL_MATRIX_COEFFICIENTS_SMPTE240; ///< SMPTE 240M
    ...
    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_BT2020_NCL =
        SDL_MATRIX_COEFFICIENTS_BT2020_NCL; ///< ITU-R BT.2020-2 non-constant luminance
    ...
    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_SMPTE2085 = SDL_MATRIX_COEFFICIENTS_SMPTE2085; ///< SMPTE ST 2085
    ...
    constexpr MatrixCoefficients MATRIX_COEFFICIENTS_ICTCP = SDL_MATRIX_COEFFICIENTS_ICTCP; ///< ITU-R BT.2100-0 ICTCP
    ...
    constexpr ChromaLocation CHROMA_LOCATION_NONE = SDL_CHROMA_LOCATION_NONE; ///< RGB, no chroma sampling
    ...
    class Colorspace
    {
      ...
      public:
         ...
         */
        constexpr Colorspace(ColorspaceRaw cspace = {}) noexcept : m_cspace(cspace)
        {
        }
    ...
    constexpr Colorspace::Colorspace(ColorType type,
                                     ...
                                     MatrixCoefficients matrix,
                                     ChromaLocation chroma)
        : m_cspace(SDL_DEFINE_COLORSPACE(type, range, primaries, transfer, matrix, chroma))
    {
    }
    ...
    struct Color : ColorRaw
    {
         ...
         */
        constexpr Color(ColorRaw color = {}) noexcept : ColorRaw(color)
        {
        }
         ...
         */
        constexpr Color(Uint8 r, Uint8 g, Uint8 b, Uint8 a) noexcept : ColorRaw{r, g, b, a}
        {
        }
    ...
    struct FColor : FColorRaw
    {
         ...
         * @param color the value to be wrapped
         */
        constexpr FColor(const FColorRaw &color = {}) noexcept : FColorRaw(color)
        {
        }
         ...
         * @param a the value for a.
         */
        constexpr FColor(float r, float g, float b, float a) noexcept : FColorRaw{r, g, b, a}
        {
        }
    ...
    class PaletteIndex
    {
      ...
      public:
        constexpr PaletteIndex(PaletteRaw palette, int index) : m_palette{palette}, m_index{index}
        {
        }
    ...
    struct Palette : PaletteBase
    {
         ...
         */
        constexpr explicit Palette(PaletteRaw resource) noexcept : PaletteBase(resource)
        {
        }

        /// Copy constructor
        constexpr Palette(const Palette &other) : Palette(borrow(other.get()))
        {
        }

        /// Move constructor
        constexpr Palette(Palette &&other) noexcept : Palette(other.release())
        {
        }
    ...
    inline void GetMasksForPixelFormat(PixelFormatRaw format,
                                       ...
                                       Uint32 *Amask)
    {
        CheckError(SDL_GetMasksForPixelFormat(format, bpp, Rmask, Gmask, Bmask, Amask));
    }

    inline void PixelFormat::GetMasks(int *bpp, Uint32 *Rmask, Uint32 *Gmask, Uint32 *Bmask, Uint32 *Amask) const
    {
     ...
     * @sa GetMasksForPixelFormat
     */
    inline PixelFormat GetPixelFormatForMasks(int bpp, Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
    {
        return SDL_GetPixelFormatForMasks(bpp, Rmask, Gmask, Bmask, Amask);
    }

    inline PixelFormat PixelFormat::ForMasks(int bpp, Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
    {
    ...
    inline Palette::Palette(int ncolors) : Palette(CheckError(SDL_CreatePalette(ncolors)))
    {
    }
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SetPaletteColors(PaletteRef palette, SpanRef<const ColorRaw> colors, int firstcolor = 0)
    {
        CheckError(SDL_SetPaletteColors(palette, colors, firstcolor));
    }

    inline void PaletteBase::SetColors(SpanRef<const ColorRaw> colors, int firstcolor)
    {
     ...
     * @sa CreatePalette
     */
    inline void DestroyPalette(PaletteRaw palette)
    {
        SDL_DestroyPalette(palette);
    }

    inline void PaletteBase::Destroy()
    {
        DestroyPalette(release());
    }
     ...
     * @sa MapSurfaceRGB
     */
    inline Uint32 MapRGB(const PixelFormatDetails &format, PaletteConstRef palette, Uint8 r, Uint8 g, Uint8 b)
    {
     ...
     * @sa MapSurfaceRGBA
     */
    inline Uint32 MapColor(const PixelFormatDetails &format, ColorRaw c, PaletteConstRef palette = {})
    {
        return SDL_MapRGBA(&format, c, palette);
    }

    inline Uint32 Color::Map(const PixelFormatDetails &format, PaletteConstRef palette) const
    {
        static_assert(false, "Not implemented");
    }
    ...
    inline Color GetColor(Uint32 pixel, const PixelFormatDetails &format, PaletteConstRef palette = {})
    {
        static_assert(false, "Not implemented");
    }

    inline Color Color::Get(Uint32 pixel, const PixelFormatDetails &format, PaletteConstRef palette)
    {
        static_assert(false, "Not implemented");
    }
