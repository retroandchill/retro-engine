...
namespace SDL
{
    ...
    constexpr BlendMode BLENDMODE_NONE = SDL_BLENDMODE_NONE; ///< no blending: dstRGBA = srcRGBA
    ...
    constexpr BlendMode BLENDMODE_BLEND_PREMULTIPLIED = SDL_BLENDMODE_BLEND_PREMULTIPLIED;
    ...
    constexpr BlendMode BLENDMODE_ADD_PREMULTIPLIED = SDL_BLENDMODE_ADD_PREMULTIPLIED;
    ...
    constexpr BlendOperation BLENDOPERATION_ADD = SDL_BLENDOPERATION_ADD; ///< dst + src: supported by all renderers
    ...
    constexpr BlendOperation BLENDOPERATION_REV_SUBTRACT = SDL_BLENDOPERATION_REV_SUBTRACT;
    ...
    constexpr BlendFactor BLENDFACTOR_SRC_COLOR = SDL_BLENDFACTOR_SRC_COLOR; ///< srcR, srcG, srcB, srcA

    constexpr BlendFactor BLENDFACTOR_ONE_MINUS_SRC_COLOR =
        SDL_BLENDFACTOR_ONE_MINUS_SRC_COLOR; ///< 1-srcR, 1-srcG, 1-srcB, 1-srcA

    constexpr BlendFactor BLENDFACTOR_SRC_ALPHA = SDL_BLENDFACTOR_SRC_ALPHA; ///< srcA, srcA, srcA, srcA

    constexpr BlendFactor BLENDFACTOR_ONE_MINUS_SRC_ALPHA =
        SDL_BLENDFACTOR_ONE_MINUS_SRC_ALPHA; ///< 1-srcA, 1-srcA, 1-srcA, 1-srcA

    constexpr BlendFactor BLENDFACTOR_DST_COLOR = SDL_BLENDFACTOR_DST_COLOR; ///< dstR, dstG, dstB, dstA

    constexpr BlendFactor BLENDFACTOR_ONE_MINUS_DST_COLOR =
        SDL_BLENDFACTOR_ONE_MINUS_DST_COLOR; ///< 1-dstR, 1-dstG, 1-dstB, 1-dstA

    constexpr BlendFactor BLENDFACTOR_DST_ALPHA = SDL_BLENDFACTOR_DST_ALPHA; ///< dstA, dstA, dstA, dstA
     ...
     *
     * The functions SetRenderDrawBlendMode and SetTextureBlendMode accept the
     ...
     * SetRenderDrawBlendMode or SetTextureBlendMode. They will return with an error
     * if the blend mode is not supported.
     *
