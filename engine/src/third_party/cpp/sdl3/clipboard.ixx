...
namespace SDL
{
     ...
     * @sa SetPrimarySelectionText
     */
    inline bool HasPrimarySelectionText()
    {
     ...
     * @sa SetClipboardData
     */
    using ClipboardDataCallback = const void *(SDLCALL *)(void *userdata, const char *mime_type, size_t *size);
     ...
     * @sa SetClipboardData
     */
    inline void ClearClipboardData()
    {
