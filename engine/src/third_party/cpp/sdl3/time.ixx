...
namespace SDL
{
    ...
    struct DateTime : DateTimeRaw
    {
         ...
         */
        constexpr DateTime(const DateTimeRaw &dateTime = {}) noexcept : DateTimeRaw(dateTime)
        {
        }
        ...
        constexpr DateTime(int year,
            ...
            : DateTimeRaw{year, month, day, hour, minute, second, nanosecond, day_of_week, utc_offset}
        {
        }
    ...
    constexpr DateFormat DATE_FORMAT_YYYYMMDD = SDL_DATE_FORMAT_YYYYMMDD; ///< Year/Month/Day

    constexpr DateFormat DATE_FORMAT_DDMMYYYY = SDL_DATE_FORMAT_DDMMYYYY; ///< Day/Month/Year

    constexpr DateFormat DATE_FORMAT_MMDDYYYY = SDL_DATE_FORMAT_MMDDYYYY; ///< Month/Day/Year
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void GetDateTimeLocalePreferences(DateFormat *dateFormat, TimeFormat *timeFormat)
    {
    ...
    {
        return CheckError(SDL_GetCurrentTime(m_time));
    }
    ...
    inline DateTime::operator Time() const
    {
        return SDL::DateTimeToTime();
    }
