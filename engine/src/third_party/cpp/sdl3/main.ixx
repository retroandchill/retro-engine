...
#define SDL3PP_MAIN_USE_CALLBACKS SDL_MAIN_USE_CALLBACKS
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline int RunApp(int argc, char *argv[], main_func mainFunction, void *reserved)
    {
     ...
     * @sa AddEventWatch
     */
    inline void GDKSuspendComplete()
    {
