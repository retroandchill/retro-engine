...
namespace SDL
{
    ...
    struct Point : PointRaw
    {
         ...
         */
        constexpr Point(const PointRaw &p = {}) noexcept : PointRaw(p)
        {
        }
         ...
         */
        constexpr Point(int x, int y) noexcept : PointRaw{x, y}
        {
        }
    ...
    struct FPoint : FPointRaw
    {
         ...
         * @param p the value to be wrapped
         */
        constexpr FPoint(const FPointRaw &p = {}) noexcept : FPointRaw(p)
        {
        }
         ...
         * @param y the value for y.
         */
        constexpr FPoint(float x, float y) noexcept : FPointRaw{x, y}
        {
        }
    ...
    struct Rect : RectRaw
    {
         ...
         */
        constexpr Rect(const RectRaw &r = {}) noexcept : RectRaw(r)
        {
        }
         ...
         */
        constexpr Rect(int x, int y, int w, int h) noexcept : RectRaw{x, y, w, h}
        {
        }
    ...
    struct FRect : FRectRaw
    {
         ...
         * @param r the value to be wrapped
         */
        constexpr FRect(const FRectRaw &r = {}) noexcept : FRectRaw(r)
        {
        }
         ...
         * @param h the value for h.
         */
        constexpr FRect(float x, float y, float w, float h) noexcept : FRectRaw{x, y, w, h}
        {
        }
         ...
         * @since This function is available since SDL 3.2.0.
         */
        static constexpr FRect GetEnclosingPoints(SpanRef<const FPointRaw> points,
        ...
        static constexpr FRect FromCenter(const FPointRaw &center, const FPointRaw &size)
        {
            static_assert(false, "Not implemented");
        }
    ...
    constexpr Rect::operator SDL_FRect() const
    {
        return SDL::RectToFRect();
    }
    ...
    constexpr bool Rect::Empty() const
    {
        return SDL::RectEmpty(this);
    }
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline Rect GetRectEnclosingPoints(SpanRef<const PointRaw> points, OptionalRef<const RectRaw> clip = std::nullopt)
    {
        return SDL_GetRectEnclosingPoints(points, clip);
    }

    inline Rect Rect::GetEnclosingPoints(SpanRef<const PointRaw> points, OptionalRef<const RectRaw> clip)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline bool GetRectAndLineIntersection(const RectRaw &rect, int *X1, int *Y1, int *X2, int *Y2)
    {
    ...
    constexpr bool FRect::Empty() const
    {
        return SDL::RectEmptyFloat(this);
    }
     ...
     * @sa RectsEqualFloat
     */
    constexpr bool RectsEqualEpsilon(const FRectRaw &self, const FRectRaw &other, const float epsilon)
    {
        return SDL_RectsEqualEpsilon(self, other, epsilon);
    }

    constexpr bool FRect::EqualEpsilon(const FRectRaw &other, const float epsilon) const
    {
     ...
     * @sa GetRectIntersectionFloat
     */
    constexpr bool HasRectIntersectionFloat(const FRectRaw &self, const FRectRaw &other)
    {
     ...
     * @sa HasRectIntersectionFloat
     */
    constexpr FRect GetRectIntersectionFloat(const FRectRaw &self, const FRectRaw &other)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    constexpr FRect GetRectEnclosingPointsFloat(SpanRef<const FPointRaw> points,
                                                OptionalRef<const FRectRaw> clip = std::nullopt)
    {
        return SDL_GetRectEnclosingPointsFloat(points, clip);
    }

    constexpr FRect FRect::GetEnclosingPoints(SpanRef<const FPointRaw> points, OptionalRef<const FRectRaw> clip)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline bool GetRectAndLineIntersectionFloat(const FRectRaw &rect, float *X1, float *Y1, float *X2, float *Y2)
    {
        return SDL_GetRectAndLineIntersectionFloat(rect, X1, Y1, X2, Y2);
    }

    inline bool FRect::GetLineIntersection(float *X1, float *Y1, float *X2, float *Y2) const
    {
