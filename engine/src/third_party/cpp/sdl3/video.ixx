...
namespace SDL
{
     ...
     */
    using WindowRef = ResourceRefT<WindowBase>;
     ...
     * mode
     */
    constexpr DisplayOrientation ORIENTATION_LANDSCAPE_FLIPPED = SDL_ORIENTATION_LANDSCAPE_FLIPPED;

    constexpr DisplayOrientation ORIENTATION_PORTRAIT = SDL_ORIENTATION_PORTRAIT; ///< The display is in portrait mode
    ...
    class Display
    {
      ...
      public:
         ...
         */
        constexpr Display(DisplayID displayID = {}) noexcept : m_displayID(displayID)
        {
        }
         ...
         */
        constexpr operator DisplayID() const noexcept
        {
            return m_displayID;
        }
    ...
    namespace prop::Global
    {
         ...
         * initialization, or NULL. See docs/README-wayland.md for more information.
         *
         * \since This macro is available since SDL 3.2.0.
         */
        constexpr auto VIDEO_WAYLAND_WL_DISPLAY_POINTER = SDL_PROP_GLOBAL_VIDEO_WAYLAND_WL_DISPLAY_POINTER;
    ...
    constexpr SystemTheme SYSTEM_THEME_UNKNOWN = SDL_SYSTEM_THEME_UNKNOWN; ///< Unknown system theme

    constexpr SystemTheme SYSTEM_THEME_LIGHT = SDL_SYSTEM_THEME_LIGHT; ///< Light colored system theme

    constexpr SystemTheme SYSTEM_THEME_DARK = SDL_SYSTEM_THEME_DARK; ///< Dark colored system theme
    ...
    constexpr WindowFlags WINDOW_FULLSCREEN = SDL_WINDOW_FULLSCREEN; ///< window is in fullscreen mode

    constexpr WindowFlags WINDOW_OPENGL = SDL_WINDOW_OPENGL; ///< window usable with OpenGL context

    constexpr WindowFlags WINDOW_OCCLUDED = SDL_WINDOW_OCCLUDED; ///< window is occluded
    ...
    constexpr WindowFlags WINDOW_BORDERLESS = SDL_WINDOW_BORDERLESS; ///< no window decoration

    constexpr WindowFlags WINDOW_RESIZABLE = SDL_WINDOW_RESIZABLE; ///< window can be resized

    constexpr WindowFlags WINDOW_MINIMIZED = SDL_WINDOW_MINIMIZED; ///< window is minimized

    constexpr WindowFlags WINDOW_MAXIMIZED = SDL_WINDOW_MAXIMIZED; ///< window is maximized

    constexpr WindowFlags WINDOW_MOUSE_GRABBED = SDL_WINDOW_MOUSE_GRABBED; ///< window has grabbed mouse input

    constexpr WindowFlags WINDOW_INPUT_FOCUS = SDL_WINDOW_INPUT_FOCUS; ///< window has input focus

    constexpr WindowFlags WINDOW_MOUSE_FOCUS = SDL_WINDOW_MOUSE_FOCUS; ///< window has mouse focus

    constexpr WindowFlags WINDOW_EXTERNAL = SDL_WINDOW_EXTERNAL; ///< window not created by SDL
    ...
    constexpr WindowFlags WINDOW_ALWAYS_ON_TOP = SDL_WINDOW_ALWAYS_ON_TOP; ///< window should always be above others
    ...
    constexpr WindowFlags WINDOW_KEYBOARD_GRABBED = SDL_WINDOW_KEYBOARD_GRABBED; ///< window has grabbed keyboard input
    ...
    constexpr WindowFlags WINDOW_VULKAN = SDL_WINDOW_VULKAN; ///< window usable for Vulkan surface

    constexpr WindowFlags WINDOW_METAL = SDL_WINDOW_METAL; ///< window usable for Metal view

    constexpr WindowFlags WINDOW_TRANSPARENT = SDL_WINDOW_TRANSPARENT; ///< window with transparent buffer

    constexpr WindowFlags WINDOW_NOT_FOCUSABLE = SDL_WINDOW_NOT_FOCUSABLE; ///< window should not be focusable
    ...
    constexpr FlashOperation FLASH_CANCEL = SDL_FLASH_CANCEL; ///< Cancel any window flash state

    constexpr FlashOperation FLASH_BRIEFLY = SDL_FLASH_BRIEFLY; ///< Flash the window briefly to get attention

    constexpr FlashOperation FLASH_UNTIL_FOCUSED = SDL_FLASH_UNTIL_FOCUSED; ///< Flash the window until it gets focus
    ...
    constexpr HitTestResult HITTEST_NORMAL = SDL_HITTEST_NORMAL; ///< Region is normal. No special properties.

    constexpr HitTestResult HITTEST_DRAGGABLE = SDL_HITTEST_DRAGGABLE; ///< Region can drag entire window.

    constexpr HitTestResult HITTEST_RESIZE_TOPLEFT =
        SDL_HITTEST_RESIZE_TOPLEFT; ///< Region is the resizable top-left corner border.

    constexpr HitTestResult HITTEST_RESIZE_TOP = SDL_HITTEST_RESIZE_TOP; ///< Region is the resizable top border.
    ...
    constexpr HitTestResult HITTEST_RESIZE_RIGHT = SDL_HITTEST_RESIZE_RIGHT; ///< Region is the resizable right border.

    /// Region is the resizable bottom-right corner border.
    constexpr HitTestResult HITTEST_RESIZE_BOTTOMRIGHT = SDL_HITTEST_RESIZE_BOTTOMRIGHT;
    ...
    constexpr HitTestResult HITTEST_RESIZE_LEFT = SDL_HITTEST_RESIZE_LEFT; ///< Region is the resizable left border.
     ...
     * @sa SetWindowHitTest
     */
    using HitTest = HitTestResult(SDLCALL *)(WindowRaw win, const PointRaw *area, void *data);
     ...
     * @sa HitTest
     */
    using HitTestCB = MakeTrailingCallback<HitTestResult(WindowRaw win, const PointRaw *area)>;
    ...
    constexpr ProgressState PROGRESS_STATE_NONE = SDL_PROGRESS_STATE_NONE; ///< No progress bar is shown
     ...
     * @see Window
     */
    struct WindowBase : ResourceBaseT<WindowRaw>
    {
    ...
    struct Window : WindowBase
    {
         ...
         */
        constexpr explicit Window(WindowRaw resource) noexcept : WindowBase(resource)
        {
        }

        /// Move constructor
        constexpr Window(Window &&other) noexcept : Window(other.release())
        {
        }
         ...
         * @sa CreateWindow
         */
        Window(StringParam title, const PointRaw &size, WindowFlags window_flags, RendererBase *renderer);
    ...
    struct GLContextScoped : GLContext
    {
        ...
        /// Move constructor
        constexpr GLContextScoped(GLContextScoped &&other) noexcept : GLContext(other.release())
        {
        }

        /// Move constructor
        constexpr GLContextScoped(GLContext &&other) noexcept : GLContext(std::move(other).release())
        {
        }
     ...
     * @sa EGL_SetAttributeCallbacks
     */
    using EGLIntArrayCallback = EGLint *(SDLCALL *)(void *userdata, EGLDisplay display, EGLConfig config);
    ...
    constexpr GLAttr GL_STEREO = SDL_GL_STEREO; ///< whether the output is stereo 3D; defaults to off.
    ...
    constexpr GLAttr GL_RETAINED_BACKING = SDL_GL_RETAINED_BACKING; ///< not used (deprecated).

    constexpr GLAttr GL_CONTEXT_MAJOR_VERSION = SDL_GL_CONTEXT_MAJOR_VERSION; ///< OpenGL context major version.

    constexpr GLAttr GL_CONTEXT_MINOR_VERSION = SDL_GL_CONTEXT_MINOR_VERSION; ///< OpenGL context minor version.
     ...
     * NO_NOTIFICATION.
     */
    constexpr GLAttr GL_CONTEXT_RESET_NOTIFICATION = SDL_GL_CONTEXT_RESET_NOTIFICATION;

    constexpr GLAttr GL_CONTEXT_NO_ERROR = SDL_GL_CONTEXT_NO_ERROR; ///< GL_CONTEXT_NO_ERROR
    ...
    constexpr GLProfile GL_CONTEXT_PROFILE_CORE = SDL_GL_CONTEXT_PROFILE_CORE; ///< OpenGL Core Profile context
    ...
    constexpr GLProfile GL_CONTEXT_PROFILE_ES = SDL_GL_CONTEXT_PROFILE_ES; ///< GLX_CONTEXT_ES2_PROFILE_BIT_EXT
    ...
    constexpr GLContextFlag GL_CONTEXT_DEBUG_FLAG = SDL_GL_CONTEXT_DEBUG_FLAG; ///< DEBUG_FLAG

    constexpr GLContextFlag GL_CONTEXT_FORWARD_COMPATIBLE_FLAG =
        SDL_GL_CONTEXT_FORWARD_COMPATIBLE_FLAG; ///< FORWARD_COMPATIBLE_FLAG

    constexpr GLContextFlag GL_CONTEXT_ROBUST_ACCESS_FLAG = SDL_GL_CONTEXT_ROBUST_ACCESS_FLAG; ///< ROBUST_ACCESS_FLAG
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline SystemTheme GetSystemTheme()
    {
    ...
    inline Display Display::GetPrimary()
    {
        return SDL::GetPrimaryDisplay();
    }
    ...
    namespace prop::Display
    {
        ...
        constexpr auto HDR_ENABLED_BOOLEAN = SDL_PROP_DISPLAY_HDR_ENABLED_BOOLEAN; ///< Hdr enabled enabled.

        constexpr auto KMSDRM_PANEL_ORIENTATION_NUMBER =
            SDL_PROP_DISPLAY_KMSDRM_PANEL_ORIENTATION_NUMBER; ///< Number for kmsdrm panel orientation.
     ...
     * @sa GetFullscreenDisplayModes
     */
    inline DisplayMode GetClosestFullscreenDisplayMode(Display displayID,
                                                       const PointRaw &size,
                                                       float refresh_rate,
                                                       bool include_high_density_modes)
    {
        return CheckError(
            SDL_GetClosestFullscreenDisplayMode(displayID, size, refresh_rate, include_high_density_modes));
    }

    inline DisplayMode Display::GetClosestFullscreenMode(const PointRaw &size,
                                                         float refresh_rate,
                                                         bool include_high_density_modes) const
    {
        return SDL::GetClosestFullscreenDisplayMode(m_displayID, size, refresh_rate, include_high_density_modes);
    }
    ...
    inline Display WindowBase::GetDisplay() const
    {
    ...
    inline float WindowBase::GetPixelDensity() const
    {
    ...
    inline float WindowBase::GetDisplayScale() const
    {
     ...
     * @sa SyncWindow
     */
    inline void SetWindowFullscreenMode(WindowRef window, OptionalRef<const DisplayMode> mode)
    {
        CheckError(SDL_SetWindowFullscreenMode(window, mode));
    }

    inline void WindowBase::SetFullscreenMode(OptionalRef<const DisplayMode> mode)
    {
    ...
    inline const DisplayMode &WindowBase::GetFullscreenMode() const
    {
    ...
    inline OwnPtr<void> WindowBase::GetICCProfile() const
    {
    ...
    inline PixelFormat WindowBase::GetPixelFormat() const
    {
     ...
     * @sa DestroyWindow
     */
    inline Window CreateWindow(StringParam title, const PointRaw &size, WindowFlags flags)
    {
        return Window(std::move(title), size, flags);
    }

    inline Window::Window(StringParam title, const PointRaw &size, WindowFlags flags)
        : Window(SDL_CreateWindow(title, size, flags))
    {
    }

    inline Window::Window(WindowRef parent, const PointRaw &offset, const PointRaw &size, WindowFlags flags)
        : Window(SDL_CreatePopupWindow(parent, offset, size, flags))
    {
    }

    inline Window::Window(PropertiesRef props) : Window(SDL_CreateWindowWithProperties(props))
    {
    }
     ...
     * @sa GetWindowParent
     */
    inline Window CreatePopupWindow(WindowRef parent, const PointRaw &offset, const PointRaw &size, WindowFlags flags)
    {
    ...
    namespace prop::Window::Create
    {
        ...
        constexpr auto ALWAYS_ON_TOP_BOOLEAN = SDL_PROP_WINDOW_CREATE_ALWAYS_ON_TOP_BOOLEAN; ///< Enable always on top.

        constexpr auto BORDERLESS_BOOLEAN = SDL_PROP_WINDOW_CREATE_BORDERLESS_BOOLEAN; ///< Enable borderless.
        ...
        constexpr auto FOCUSABLE_BOOLEAN = SDL_PROP_WINDOW_CREATE_FOCUSABLE_BOOLEAN; ///< Enable focusable.

        constexpr auto EXTERNAL_GRAPHICS_CONTEXT_BOOLEAN =
            SDL_PROP_WINDOW_CREATE_EXTERNAL_GRAPHICS_CONTEXT_BOOLEAN; ///< Enable external graphics context.

        constexpr auto FLAGS_NUMBER = SDL_PROP_WINDOW_CREATE_FLAGS_NUMBER; ///< Number for flags.

        constexpr auto FULLSCREEN_BOOLEAN = SDL_PROP_WINDOW_CREATE_FULLSCREEN_BOOLEAN; ///< Enable fullscreen.

        constexpr auto HEIGHT_NUMBER = SDL_PROP_WINDOW_CREATE_HEIGHT_NUMBER; ///< Number for height.

        constexpr auto HIDDEN_BOOLEAN = SDL_PROP_WINDOW_CREATE_HIDDEN_BOOLEAN; ///< Enable hidden.

        constexpr auto HIGH_PIXEL_DENSITY_BOOLEAN =
            SDL_PROP_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN; ///< Enable high pixel density.

        constexpr auto MAXIMIZED_BOOLEAN = SDL_PROP_WINDOW_CREATE_MAXIMIZED_BOOLEAN; ///< Enable maximized.

        constexpr auto MENU_BOOLEAN = SDL_PROP_WINDOW_CREATE_MENU_BOOLEAN; ///< Enable menu.

        constexpr auto METAL_BOOLEAN = SDL_PROP_WINDOW_CREATE_METAL_BOOLEAN; ///< Enable metal.

        constexpr auto MINIMIZED_BOOLEAN = SDL_PROP_WINDOW_CREATE_MINIMIZED_BOOLEAN; ///< Enable minimized.

        constexpr auto MODAL_BOOLEAN = SDL_PROP_WINDOW_CREATE_MODAL_BOOLEAN; ///< Enable modal.

        constexpr auto MOUSE_GRABBED_BOOLEAN = SDL_PROP_WINDOW_CREATE_MOUSE_GRABBED_BOOLEAN; ///< Enable mouse grabbed.

        constexpr auto OPENGL_BOOLEAN = SDL_PROP_WINDOW_CREATE_OPENGL_BOOLEAN; ///< Enable opengl.

        constexpr auto PARENT_POINTER = SDL_PROP_WINDOW_CREATE_PARENT_POINTER; ///< Pointer to parent.

        constexpr auto RESIZABLE_BOOLEAN = SDL_PROP_WINDOW_CREATE_RESIZABLE_BOOLEAN; ///< Enable resizable.

        constexpr auto TITLE_STRING = SDL_PROP_WINDOW_CREATE_TITLE_STRING; ///< String for title.

        constexpr auto TRANSPARENT_BOOLEAN = SDL_PROP_WINDOW_CREATE_TRANSPARENT_BOOLEAN; ///< Enable transparent.

        constexpr auto TOOLTIP_BOOLEAN = SDL_PROP_WINDOW_CREATE_TOOLTIP_BOOLEAN; ///< Enable tooltip.

        constexpr auto UTILITY_BOOLEAN = SDL_PROP_WINDOW_CREATE_UTILITY_BOOLEAN; ///< Enable utility.

        constexpr auto VULKAN_BOOLEAN = SDL_PROP_WINDOW_CREATE_VULKAN_BOOLEAN; ///< Enable vulkan.

        constexpr auto WIDTH_NUMBER = SDL_PROP_WINDOW_CREATE_WIDTH_NUMBER; ///< Number for width.
        ...
        constexpr auto COCOA_WINDOW_POINTER = SDL_PROP_WINDOW_CREATE_COCOA_WINDOW_POINTER; ///< Pointer to cocoa window.

        constexpr auto COCOA_VIEW_POINTER = SDL_PROP_WINDOW_CREATE_COCOA_VIEW_POINTER; ///< Pointer to cocoa view.

#if SDL_VERSION_ATLEAST(3, 4, 0)

        constexpr auto WINDOWSCENE_POINTER = SDL_PROP_WINDOW_CREATE_WINDOWSCENE_POINTER; ///< Pointer to windowscene.

#endif // SDL_VERSION_ATLEAST(3, 4, 0)

        constexpr auto WAYLAND_SURFACE_ROLE_CUSTOM_BOOLEAN =
            SDL_PROP_WINDOW_CREATE_WAYLAND_SURFACE_ROLE_CUSTOM_BOOLEAN; ///< Enable wayland surface role custom.

        constexpr auto WAYLAND_CREATE_EGL_WINDOW_BOOLEAN =
            SDL_PROP_WINDOW_CREATE_WAYLAND_CREATE_EGL_WINDOW_BOOLEAN; ///< Enable wayland create egl window.

        constexpr auto WAYLAND_WL_SURFACE_POINTER =
            SDL_PROP_WINDOW_CREATE_WAYLAND_WL_SURFACE_POINTER; ///< Pointer to wayland wl surface.

        constexpr auto WIN32_HWND_POINTER = SDL_PROP_WINDOW_CREATE_WIN32_HWND_POINTER; ///< Pointer to win32 hwnd.

        constexpr auto WIN32_PIXEL_FORMAT_HWND_POINTER =
            SDL_PROP_WINDOW_CREATE_WIN32_PIXEL_FORMAT_HWND_POINTER; ///< Pointer to win32 pixel format hwnd.

        constexpr auto X11_WINDOW_NUMBER = SDL_PROP_WINDOW_CREATE_X11_WINDOW_NUMBER; ///< Number for x11 window.

#if SDL_VERSION_ATLEAST(3, 4, 0)

        constexpr auto EMSCRIPTEN_CANVAS_ID_STRING =
            SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_CANVAS_ID_STRING; ///< String for emscripten canvas id.

        constexpr auto EMSCRIPTEN_KEYBOARD_ELEMENT_STRING =
            SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_KEYBOARD_ELEMENT_STRING; ///< String for emscripten keyboard element.
    ...
    inline WindowID WindowBase::GetID() const
    {
        return SDL::GetWindowID(get());
    }
    ...
    inline WindowRef WindowBase::FromID(WindowID id)
    {
    ...
    inline PropertiesRef WindowBase::GetProperties() const
    {
    ...
    namespace prop::Window
    {
        ...
        constexpr auto SHAPE_POINTER = SDL_PROP_WINDOW_SHAPE_POINTER; ///< Pointer to shape.

        constexpr auto HDR_ENABLED_BOOLEAN = SDL_PROP_WINDOW_HDR_ENABLED_BOOLEAN; ///< Hdr enabled enabled.

        constexpr auto SDR_WHITE_LEVEL_FLOAT = SDL_PROP_WINDOW_SDR_WHITE_LEVEL_FLOAT; ///< Float for sdr white level.

        constexpr auto HDR_HEADROOM_FLOAT = SDL_PROP_WINDOW_HDR_HEADROOM_FLOAT; ///< Float for hdr headroom.

        constexpr auto ANDROID_WINDOW_POINTER = SDL_PROP_WINDOW_ANDROID_WINDOW_POINTER; ///< Pointer to android window.

        constexpr auto ANDROID_SURFACE_POINTER =
            SDL_PROP_WINDOW_ANDROID_SURFACE_POINTER; ///< Pointer to android surface.

        constexpr auto UIKIT_WINDOW_POINTER = SDL_PROP_WINDOW_UIKIT_WINDOW_POINTER; ///< Pointer to uikit window.

        constexpr auto UIKIT_METAL_VIEW_TAG_NUMBER =
            SDL_PROP_WINDOW_UIKIT_METAL_VIEW_TAG_NUMBER; ///< Number for uikit metal view tag.

        constexpr auto UIKIT_OPENGL_FRAMEBUFFER_NUMBER =
            SDL_PROP_WINDOW_UIKIT_OPENGL_FRAMEBUFFER_NUMBER; ///< Number for uikit opengl framebuffer.

        constexpr auto UIKIT_OPENGL_RENDERBUFFER_NUMBER =
            SDL_PROP_WINDOW_UIKIT_OPENGL_RENDERBUFFER_NUMBER; ///< Number for uikit opengl renderbuffer.

        constexpr auto UIKIT_OPENGL_RESOLVE_FRAMEBUFFER_NUMBER =
            SDL_PROP_WINDOW_UIKIT_OPENGL_RESOLVE_FRAMEBUFFER_NUMBER; ///< Number for uikit opengl resolve framebuffer.

        constexpr auto KMSDRM_DEVICE_INDEX_NUMBER =
            SDL_PROP_WINDOW_KMSDRM_DEVICE_INDEX_NUMBER; ///< Number for kmsdrm device index.

        constexpr auto KMSDRM_DRM_FD_NUMBER = SDL_PROP_WINDOW_KMSDRM_DRM_FD_NUMBER; ///< Number for kmsdrm drm fd.

        constexpr auto KMSDRM_GBM_DEVICE_POINTER =
            SDL_PROP_WINDOW_KMSDRM_GBM_DEVICE_POINTER; ///< Pointer to kmsdrm gbm device.

        constexpr auto COCOA_WINDOW_POINTER = SDL_PROP_WINDOW_COCOA_WINDOW_POINTER; ///< Pointer to cocoa window.

        constexpr auto COCOA_METAL_VIEW_TAG_NUMBER =
            SDL_PROP_WINDOW_COCOA_METAL_VIEW_TAG_NUMBER; ///< Number for cocoa metal view tag.
        ...
        constexpr auto VIVANTE_WINDOW_POINTER = SDL_PROP_WINDOW_VIVANTE_WINDOW_POINTER; ///< Pointer to vivante window.

        constexpr auto VIVANTE_SURFACE_POINTER =
            SDL_PROP_WINDOW_VIVANTE_SURFACE_POINTER; ///< Pointer to vivante surface.

        constexpr auto WIN32_HWND_POINTER = SDL_PROP_WINDOW_WIN32_HWND_POINTER; ///< Pointer to win32 hwnd.

        constexpr auto WIN32_HDC_POINTER = SDL_PROP_WINDOW_WIN32_HDC_POINTER; ///< Pointer to win32 hdc.

        constexpr auto WIN32_INSTANCE_POINTER = SDL_PROP_WINDOW_WIN32_INSTANCE_POINTER; ///< Pointer to win32 instance.
        ...
        constexpr auto WAYLAND_EGL_WINDOW_POINTER =
            SDL_PROP_WINDOW_WAYLAND_EGL_WINDOW_POINTER; ///< Pointer to wayland egl window.

        constexpr auto WAYLAND_XDG_SURFACE_POINTER =
            SDL_PROP_WINDOW_WAYLAND_XDG_SURFACE_POINTER; ///< Pointer to wayland xdg surface.

        constexpr auto WAYLAND_XDG_TOPLEVEL_POINTER =
            SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_POINTER; ///< Pointer to wayland xdg toplevel.

        constexpr auto WAYLAND_XDG_TOPLEVEL_EXPORT_HANDLE_STRING =
            SDL_PROP_WINDOW_WAYLAND_XDG_TOPLEVEL_EXPORT_HANDLE_STRING; ///< String for wayland xdg toplevel export
                                                                       ///< handle.
        ...
        constexpr auto WAYLAND_XDG_POSITIONER_POINTER =
            SDL_PROP_WINDOW_WAYLAND_XDG_POSITIONER_POINTER; ///< Pointer to wayland xdg positioner.

        constexpr auto X11_DISPLAY_POINTER = SDL_PROP_WINDOW_X11_DISPLAY_POINTER; ///< Pointer to x11 display.

        constexpr auto X11_SCREEN_NUMBER = SDL_PROP_WINDOW_X11_SCREEN_NUMBER; ///< Number for x11 screen.

        constexpr auto X11_WINDOW_NUMBER = SDL_PROP_WINDOW_X11_WINDOW_NUMBER; ///< Number for x11 window.

#if SDL_VERSION_ATLEAST(3, 4, 0)

        constexpr auto EMSCRIPTEN_CANVAS_ID_STRING =
            SDL_PROP_WINDOW_EMSCRIPTEN_CANVAS_ID_STRING; ///< String for emscripten canvas id.

        constexpr auto EMSCRIPTEN_KEYBOARD_ELEMENT_STRING =
            SDL_PROP_WINDOW_EMSCRIPTEN_KEYBOARD_ELEMENT_STRING; ///< String for emscripten keyboard element.
    ...
    inline WindowFlags WindowBase::GetFlags() const
    {
    ...
    inline const char *WindowBase::GetTitle() const
    {
    ...
    inline void WindowBase::SetIcon(SurfaceRef icon)
    {
    ...
    inline void WindowBase::SetPosition(const PointRaw &p)
    {
    ...
    inline void WindowBase::GetPosition(int *x, int *y) const
    {
        SDL::GetWindowPosition(get(), x, y);
    }

    inline Point WindowBase::GetPosition() const
    {
    ...
    inline void WindowBase::SetSize(const PointRaw &size)
    {
    ...
    inline void WindowBase::GetSize(int *w, int *h) const
    {
        SDL::GetWindowSize(get(), w, h);
    }

    inline Point WindowBase::GetSize() const
    {
        return SDL::GetWindowSize(get());
    }
    ...
    inline void WindowBase::SetRect(Rect rect)
    {
        SDL::SetWindowRect(get(), rect);
    }
    ...
    inline Rect WindowBase::GetSafeArea() const
    {
     ...
     * @sa SyncWindow
     */
    inline void SetWindowAspectRatio(WindowRef window, float min_aspect, float max_aspect)
    {
        CheckError(SDL_SetWindowAspectRatio(window, min_aspect, max_aspect));
    }

    inline void WindowBase::SetAspectRatio(float min_aspect, float max_aspect)
    {
     ...
     * @sa SetWindowAspectRatio
     */
    inline void GetWindowAspectRatio(WindowRef window, float *min_aspect, float *max_aspect)
    {
        CheckError(SDL_GetWindowAspectRatio(window, min_aspect, max_aspect));
    }

    inline void WindowBase::GetAspectRatio(float *min_aspect, float *max_aspect) const
    {
     ...
     * @sa GetWindowSize
     */
    inline void GetWindowBordersSize(WindowRef window, int *top, int *left, int *bottom, int *right)
    {
        CheckError(SDL_GetWindowBordersSize(window, top, left, bottom, right));
    }

    inline void WindowBase::GetBordersSize(int *top, int *left, int *bottom, int *right) const
    {
    ...
    inline void WindowBase::GetSizeInPixels(int *w, int *h) const
    {
        SDL::GetWindowSizeInPixels(get(), w, h);
    }

    inline Point WindowBase::GetSizeInPixels() const
    {
    ...
    inline void WindowBase::SetMinimumSize(const PointRaw &p)
    {
    ...
    inline void WindowBase::GetMinimumSize(int *w, int *h) const
    {
    ...
    inline void WindowBase::SetMaximumSize(const PointRaw &p)
    {
    ...
    inline void WindowBase::GetMaximumSize(int *w, int *h) const
    {
    ...
    inline void WindowBase::SetBordered(bool bordered)
    {
    ...
    inline void WindowBase::SetResizable(bool resizable)
    {
    ...
    inline void WindowBase::SetAlwaysOnTop(bool on_top)
    {
    ...
    inline void WindowBase::SetFillDocument(bool fill)
    {
     ...
     * @sa RaiseWindow
     */
    inline void ShowWindow(WindowRef window)
    {
        CheckError(SDL_ShowWindow(window));
    }

    inline void WindowBase::Show()
    {
        SDL::ShowWindow(get());
    }
     ...
     * @sa WINDOW_HIDDEN
     */
    inline void HideWindow(WindowRef window)
    {
        CheckError(SDL_HideWindow(window));
    }

    inline void WindowBase::Hide()
    {
        SDL::HideWindow(get());
    }
    ...
    inline void WindowBase::Maximize()
    {
        SDL::MaximizeWindow(get());
    }
    ...
    inline void WindowBase::Minimize()
    {
        SDL::MinimizeWindow(get());
    }
    ...
    inline void WindowBase::Restore()
    {
        SDL::RestoreWindow(get());
    }
     ...
     * @sa SDL_HINT_VIDEO_SYNC_WINDOW_OPERATIONS
     */
    inline bool SyncWindow(WindowRef window)
    {
        return SDL_SyncWindow(window);
    }

    inline bool WindowBase::Sync()
    {
        return SDL::SyncWindow(get());
    }
    ...
    inline bool WindowBase::HasSurface() const
    {
        return SDL::WindowHasSurface(get());
    }
    ...
    {
        return CheckError(SDL_GetWindowSurface(window));
    }

    inline Surface WindowBase::GetSurface()
    {
        return SDL::GetWindowSurface(get());
    }
    ...
    inline void WindowBase::SetSurfaceVSync(int vsync)
    {
    ...
    inline int WindowBase::GetSurfaceVSync() const
    {
    ...
    inline void WindowBase::UpdateSurface()
    {
        SDL::UpdateWindowSurface(get());
    }
     ...
     * @sa UpdateWindowSurface
     */
    inline void UpdateWindowSurfaceRects(WindowRef window, SpanRef<const RectRaw> rects)
    {
        CheckError(SDL_UpdateWindowSurfaceRects(window, rects));
    }

    inline void WindowBase::UpdateSurfaceRects(SpanRef<const RectRaw> rects)
    {
    ...
    inline void WindowBase::DestroySurface()
    {
        SDL::DestroyWindowSurface(get());
    }
    ...
    inline void WindowBase::SetKeyboardGrab(bool grabbed)
    {
    ...
    inline void WindowBase::SetMouseGrab(bool grabbed)
    {
    ...
    inline bool WindowBase::GetKeyboardGrab() const
    {
    ...
    inline bool WindowBase::GetMouseGrab() const
    {
     ...
     * @sa SetWindowKeyboardGrab
     */
    inline WindowRef GetGrabbedWindow()
    {
        return SDL_GetGrabbedWindow();
    }

    inline WindowRef WindowBase::GetGrabbed()
    {
        return SDL::GetGrabbedWindow();
    }
    ...
    inline void WindowBase::SetMouseRect(const RectRaw &rect)
    {
    ...
    inline const RectRaw *WindowBase::GetMouseRect() const
    {
    ...
    inline void WindowBase::SetOpacity(float opacity)
    {
    ...
    inline float WindowBase::GetOpacity() const
    {
        return SDL::GetWindowOpacity(get());
    }
    ...
    inline void WindowBase::SetParent(WindowRef parent)
    {
    ...
    inline void WindowBase::SetModal(bool modal)
    {
        SDL::SetWindowModal(get(), modal);
    }
    ...
    inline void WindowBase::SetFocusable(bool focusable)
    {
    ...
    inline void WindowBase::ShowSystemMenu(const PointRaw &p)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SetWindowHitTest(WindowRef window, HitTest callback, void *callback_data)
    {
    ...
    inline void WindowBase::SetHitTest(HitTest callback, void *callback_data)
    {
    ...
    inline void WindowBase::SetShape(SurfaceRef shape)
    {
    ...
    inline void WindowBase::Flash(FlashOperation operation)
    {
    ...
    inline void WindowBase::SetProgressState(ProgressState state)
    {
    ...
    inline ProgressState WindowBase::GetProgressState()
    {
    ...
    inline void WindowBase::SetProgressValue(float value)
    {
    ...
    inline float WindowBase::GetProgressValue()
    {
    ...
    inline void WindowBase::Destroy()
    {
        DestroyWindow(release());
    }
     ...
     */
    inline bool ScreenSaverEnabled()
    {
     ...
     */
    inline void EnableScreenSaver()
    {
        CheckError(SDL_EnableScreenSaver());
    }
     ...
     * @sa ScreenSaverEnabled
     */
    inline void DisableScreenSaver()
    {
        CheckError(SDL_DisableScreenSaver());
    }
    ...
    inline GLContext WindowBase::CreateGLContext()
    {
        return GLContext(get());
    }

    inline GLContext::GLContext(WindowRef window) : GLContext(SDL_GL_CreateContext(window))
    {
    }
    ...
    inline void WindowBase::MakeCurrent(GLContext context)
    {
    ...
    {
        SDL::WindowBase::MakeCurrent(get(), window);
    }
     ...
     * @sa GL_MakeCurrent
     */
    inline GLContext GL_GetCurrentContext()
    {
    ...
    inline EGLSurface WindowBase::GetEGLSurface()
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void EGL_SetAttributeCallbacks(EGLAttribArrayCallback platformAttribCallback,
    ...
    inline void WindowBase::GL_Swap()
    {
        SDL::GL_SwapWindow(get());
    }
