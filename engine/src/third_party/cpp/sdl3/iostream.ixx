...
namespace SDL
{
    ...
    constexpr IOStatus IO_STATUS_READY = SDL_IO_STATUS_READY; ///< Everything is ready (no errors and not EOF).

    constexpr IOStatus IO_STATUS_ERROR = SDL_IO_STATUS_ERROR; ///< Read or write I/O error

    constexpr IOStatus IO_STATUS_EOF = SDL_IO_STATUS_EOF; ///< End of file

    constexpr IOStatus IO_STATUS_NOT_READY = SDL_IO_STATUS_NOT_READY; ///< Non blocking I/O, not ready

    constexpr IOStatus IO_STATUS_READONLY = SDL_IO_STATUS_READONLY; ///< Tried to write a read-only buffer

    constexpr IOStatus IO_STATUS_WRITEONLY = SDL_IO_STATUS_WRITEONLY; ///< Tried to read a write-only buffer
    ...
    constexpr IOWhence IO_SEEK_SET = SDL_IO_SEEK_SET; ///< Seek from the beginning of data

    constexpr IOWhence IO_SEEK_CUR = SDL_IO_SEEK_CUR; ///< Seek relative to current read point

    constexpr IOWhence IO_SEEK_END = SDL_IO_SEEK_END; ///< Seek relative to the end of data
    ...
    struct IOStream : IOStreamBase
    {
         ...
         */
        constexpr explicit IOStream(IOStreamRaw resource) noexcept : IOStreamBase(resource)
        {
        }

        /// Move constructor
        constexpr IOStream(IOStream &&other) noexcept : IOStream(other.release())
        {
        }
    ...
    namespace prop::IOStream
    {
        ...
        constexpr auto STDIO_FILE_POINTER = SDL_PROP_IOSTREAM_STDIO_FILE_POINTER; ///< Pointer to stdio file.
        ...
        constexpr auto MEMORY_POINTER = SDL_PROP_IOSTREAM_MEMORY_POINTER; ///< Pointer to memory.

        constexpr auto MEMORY_SIZE_NUMBER = SDL_PROP_IOSTREAM_MEMORY_SIZE_NUMBER; ///< Number for memory size.
     ...
     * @sa WriteIO
     */
    inline IOStream IOFromDynamicMem()
    {
        return IOStream(SDL_IOFromDynamicMem());
    }

    inline IOStream IOStream::FromDynamicMem()
    {
        return SDL::IOFromDynamicMem();
    }
     ...
     * @sa OpenIO
     */
    inline void CloseIO(IOStreamRaw context)
    {
        CheckError(SDL_CloseIO(context));
    }

    inline void IOStreamBase::Close()
    {
        CloseIO(release());
    }
    ...
    inline Sint64 IOStreamBase::GetSize() const
    {
        return SDL::GetIOSize(get());
    }
     ...
     * @sa SeekIO
     */
    inline Sint64 TellIO(IOStreamRef context)
    {
        return SDL_TellIO(context);
    }

    inline Sint64 IOStreamBase::Tell() const
    {
        return SDL::TellIO(get());
    }
     ...
     * @sa WriteIO
     */
    inline size_t IOprintf(IOStreamRef context, SDL_PRINTF_FORMAT_STRING const char *fmt)
    {
     ...
     * @sa WriteIO
     */
    inline size_t IOvprintf(IOStreamRef context, SDL_PRINTF_FORMAT_STRING const char *fmt, va_list ap)
    {
        return SDL_IOvprintf(context, fmt, ap);
    }

    inline size_t IOStreamBase::vprintf(SDL_PRINTF_FORMAT_STRING const char *fmt, va_list ap)
    {
     ...
     * @sa WriteIO
     */
    inline void FlushIO(IOStreamRef context)
    {
        CheckError(SDL_FlushIO(context));
    }

    inline void IOStreamBase::Flush()
    {
        SDL::FlushIO(get());
    }
    ...
    inline StringResult IOStreamBase::LoadFile()
    {
        return SDL::LoadFile_IO(get());
    }
    ...
    {
        return CheckError(SDL_ReadU8(src));
    }

    inline Uint8 IOStreamBase::ReadU8()
    {
        return SDL::ReadU8(get());
    }
    ...
    {
        return CheckError(SDL_ReadS8(src));
    }

    inline Sint8 IOStreamBase::ReadS8()
    {
        return SDL::ReadS8(get());
    }
    ...
    inline Uint16 IOStreamBase::ReadU16LE()
    {
        return SDL::ReadU16LE(get());
    }
    ...
    inline Sint16 IOStreamBase::ReadS16LE()
    {
        return SDL::ReadS16LE(get());
    }
    ...
    inline Uint16 IOStreamBase::ReadU16BE()
    {
        return SDL::ReadU16BE(get());
    }
    ...
    inline Sint16 IOStreamBase::ReadS16BE()
    {
        return SDL::ReadS16BE(get());
    }
    ...
    inline Uint32 IOStreamBase::ReadU32LE()
    {
        return SDL::ReadU32LE(get());
    }
    ...
    inline Sint32 IOStreamBase::ReadS32LE()
    {
        return SDL::ReadS32LE(get());
    }
    ...
    inline Uint32 IOStreamBase::ReadU32BE()
    {
        return SDL::ReadU32BE(get());
    }
    ...
    inline Sint32 IOStreamBase::ReadS32BE()
    {
        return SDL::ReadS32BE(get());
    }
    ...
    inline Uint64 IOStreamBase::ReadU64LE()
    {
        return SDL::ReadU64LE(get());
    }
    ...
    inline Sint64 IOStreamBase::ReadS64LE()
    {
        return SDL::ReadS64LE(get());
    }
    ...
    inline Uint64 IOStreamBase::ReadU64BE()
    {
        return SDL::ReadU64BE(get());
    }
    ...
    inline Sint64 IOStreamBase::ReadS64BE()
    {
        return SDL::ReadS64BE(get());
    }
    ...
    inline void IOStreamBase::WriteU8(Uint8 value)
    {
        SDL::WriteU8(get(), value);
    }
    ...
    inline void IOStreamBase::WriteS8(Sint8 value)
    {
        SDL::WriteS8(get(), value);
    }
