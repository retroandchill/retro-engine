...
namespace SDL
{
     ...
     */
    using AudioDeviceRef = ResourceRefT<AudioDeviceBase>;
     ...
     * This does not take ownership!
     */
    using AudioStreamRef = ResourceRefT<AudioStreamBase>;
     ...
     *
     * Generally one should use AudioBitSize instead of this macro directly.
     *
     ...
     *
     * Generally one should use IsAudioFloat instead of this macro directly.
     *
     * @since This constant is available since SDL 3.2.0.
     */
     ...
     *
     * Generally one should use IsAudioBigENDIAN or IsAudioLittleEndian instead of
     * this macro directly.
     *
     * @since This constant is available since SDL 3.2.0.
     */
     ...
     *
     * Generally one should use IsAudioSigned instead of this macro directly.
     *
     * @since This constant is available since SDL 3.2.0.
     */
    ...
    class AudioFormat
    {
      ...
      public:
         ...
         */
        constexpr AudioFormat(AudioFormatRaw audioFormat = {}) noexcept : m_audioFormat(audioFormat)
        {
        }
    ...
    constexpr AudioFormat AUDIO_UNKNOWN = SDL_AUDIO_UNKNOWN; ///< Unspecified audio format
    ...
    constexpr AudioFormat AUDIO_S16BE = SDL_AUDIO_S16BE; ///< As above, but big-endian byte order

    constexpr AudioFormat AUDIO_S32LE = SDL_AUDIO_S32LE; ///< 32-bit integer samples

    constexpr AudioFormat AUDIO_S32BE = SDL_AUDIO_S32BE; ///< As above, but big-endian byte order

    constexpr AudioFormat AUDIO_F32LE = SDL_AUDIO_F32LE; ///< 32-bit floating point samples

    constexpr AudioFormat AUDIO_F32BE = SDL_AUDIO_F32BE; ///< As above, but big-endian byte order
    ...
    constexpr AudioFormat::AudioFormat(bool sign, bool bigendian, bool flt, Uint16 size)
     ...
     *                 SetAudioPostmixCallback, for its own use.
     ...
     *
     * @sa SetAudioPostmixCallback
     */
    using AudioPostmixCallback = void(SDLCALL *)(void *userdata, const AudioSpec *spec, float *buffer, int buflen);
     ...
     */
    using AudioPostmixCB = MakeFrontCallback<void(const AudioSpec *spec, float *buffer, int buflen)>;
     ...
     * when data is added with PutAudioStreamData, or requested with
     * GetAudioStreamData.
     *
     ...
     *               protect shared data, you should use LockAudioStream to
     ...
     * @since This datatype is available since SDL 3.2.0.
     *
     * @sa SetAudioStreamGetCallback
     * @sa SetAudioStreamPutCallback
     */
     ...
     */
    using AudioStreamCB = MakeFrontCallback<void(AudioStreamRaw stream, int additional_amount, int total_amount)>;
     ...
     * @see AudioDevice
     */
    struct AudioDeviceBase : ResourceBaseT<AudioDeviceID>
    {
         ...
         * @since This function is available since SDL 3.2.0.
         *
         * @sa SetAudioStreamInputChannelMap
         */
         ...
         * @since This function is available since SDL 3.2.0.
         *
         * @sa ResumeAudioDevice
         * @sa AudioDevicePaused
         */
        void Pause();
         ...
         * previously been paused with PauseAudioDevice(). Once unpaused, any bound
         ...
         * stream's format at any time with SetAudioStreamFormat(). If the other end
         ...
         *
         * @sa BindAudioStreams
         * @sa UnbindAudioStream
         * @sa GetAudioStreamDevice
         */
         ...
         * `BindAudioStreams(devid, &stream, 1)`.
         *
         ...
         * choose the format, and the app can use GetAudioStreamFormat() to obtain
         ...
         * unpaused.
         *
         * Destroying the returned stream with DestroyAudioStream will also close the
         ...
         *                 PutAudioStreamData or GetAudioStreamData as necessary.
         * @param userdata app-controlled pointer passed to callback. Can be nullptr.
         ...
         *
         * @sa GetAudioStreamDevice
         * @sa ResumeAudioStreamDevice
         */
        AudioStreamRef OpenStream(const AudioSpec &spec, AudioStreamCallback callback, void *userdata);
     ...
     * @cat resource
     */
    struct AudioDevice : AudioDeviceBase
    {
         ...
         */
        constexpr explicit AudioDevice(AudioDeviceID resource) noexcept : AudioDeviceBase(resource)
        {
        }

        /// Move constructor
        constexpr AudioDevice(AudioDevice &&other) noexcept : AudioDevice(other.release())
        {
        }
         ...
         * conversion for you as appropriate. GetAudioDeviceFormat can tell you the
         ...
         * should call CloseAudioDevice() on the returned device id.
         *
     ...
     * @since This constant is available since SDL 3.2.0.
     */
    constexpr AudioDeviceRaw AUDIO_DEVICE_DEFAULT_PLAYBACK = SDL_AUDIO_DEVICE_DEFAULT_PLAYBACK;
     ...
     * @since This constant is available since SDL 3.2.0.
     */
    constexpr AudioDeviceRaw AUDIO_DEVICE_DEFAULT_RECORDING = SDL_AUDIO_DEVICE_DEFAULT_RECORDING;
     ...
     *
     * When using PutAudioStreamDataNoCopy() to provide data to an AudioStream, it's
     * not safe to dispose of the data until the stream has completely consumed it.
     ...
     *
     * @param userdata an opaque pointer provided by the app for their personal use.
     * @param buf the pointer provided to PutAudioStreamDataNoCopy().
     ...
     * @sa SetAudioStreamPutCallback
     */
    using AudioStreamDataCompleteCallback = void(SDLCALL *)(void *userdata, const void *buf, int buflen);
     ...
     */
    using AudioStreamDataCompleteCB = std::function<void(const void *buf, int buflen)>;
     ...
     * @see AudioStream
     */
    struct AudioStreamBase : ResourceBaseT<AudioStreamRaw>
    {
        using ResourceBaseT::ResourceBaseT;
         ...
         *
         * Future calls to and GetAudioStreamAvailable and GetAudioStreamData will
         * reflect the new format, and future calls to PutAudioStreamData must provide
         ...
         * @since This function is available since SDL 3.2.0.
         *
         * @sa GetAudioStreamFormat
         * @sa SetAudioStreamFrequencyRatio
         */
         ...
         *
         * This is applied during GetAudioStreamData, and can be continuously changed
         ...
         * @since This function is available since SDL 3.2.0.
         *
         * @sa GetAudioStreamFrequencyRatio
         * @sa SetAudioStreamFormat
         */
         ...
         * PutAudioStreamData. Future calls to PutAudioStreamData must provide data in
         ...
         * @since This function is available since SDL 3.2.0.
         *
         * @sa SetAudioStreamOutputChannelMap
         */
         ...
         * applied during GetAudioStreamData.
         *
         * Audio streams default to no remapping applied. Passing a nullptr channel
         * map is legal, and turns off remapping.
         *
         ...
         * call to SetAudioStreamFormat, or the format specified when creating the
         ...
         * @sa ClearAudioStream
         * @sa FlushAudioStream
         * @sa GetAudioStreamData
         * @sa GetAudioStreamQueued
         */
         ...
         *
         * Unlike PutAudioStreamData(), this function does not make a copy of the
         ...
         * being read from the stream in its entirety, or a call to ClearAudioStream()
         ...
         * PutAudioStreamData(), which allocates and buffers in blocks.
         *
         * @param buf a pointer to the audio data to add.
         ...
         * and PutAudioStreamData simply queues unconverted data for later. This is
         ...
         *
         * @sa ClearAudioStream
         * @sa GetAudioStreamAvailable
         * @sa PutAudioStreamData
         */
         ...
         * GetAudioStreamData before this function's return value is no longer
         * clamped.
         *
         ...
         * GetAudioStreamAvailable() and not this function.
         *
         ...
         *
         * Queued data is not converted until it is consumed by GetAudioStreamData, so
         ...
         *
         * As this is just a wrapper over LockMutex for an internal lock; it has all
         ...
         *               previously called LockAudioStream.
         *
         * @since This function is available since SDL 3.2.0.
         *
         * @sa LockAudioStream
         ...
         *
         * The callback can (optionally) call PutAudioStreamData() to add more audio
         ...
         *
         * The callback can (optionally) call GetAudioStreamData() to obtain audio
         ...
         *
         * The callback may call GetAudioStreamAvailable to see the total amount
         ...
         * than PutAudioStreamData, which wants the size of a single array in bytes.
         *
     ...
     * @cat resource
     */
    struct AudioStream : AudioStreamBase
    {
         ...
         * This assumes the ownership, call release() if you need to take back.
         */
        constexpr explicit AudioStream(AudioStreamRaw resource) noexcept : AudioStreamBase(resource)
        {
        }

        /// Move constructor
        constexpr AudioStream(AudioStream &&other) noexcept : AudioStream(other.release())
        {
        }
     ...
     * that the callback is not running while the lock is held.
     *
     * As this is just a wrapper over LockMutex for an internal lock; it has all the
     * same attributes (recursive locks are allowed, etc).
     *
    ...
    class AudioStreamLock
    {
      ...
      public:
        ...
        /// Move constructor
        AudioStreamLock(AudioStreamLock &&other) noexcept : m_lock(std::move(other.m_lock))
        {
        }
    ...
    inline const char *AudioDeviceBase::GetName() const
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline AudioSpec GetAudioDeviceFormat(AudioDeviceRef devid, int *sample_frames = nullptr)
    {
        return CheckError(SDL_GetAudioDeviceFormat(devid, sample_frames));
    }

    inline AudioSpec AudioDeviceBase::GetFormat(int *sample_frames) const
    {
    ...
    inline OwnArray<int> AudioDeviceBase::GetChannelMap() const
    {
     ...
     * as appropriate. GetAudioDeviceFormat can tell you the preferred format for
    ...
    inline AudioDevice::AudioDevice(AudioDeviceRef devid, OptionalRef<const AudioSpec> spec)
    ...
    inline bool AudioDeviceBase::IsPhysical() const
    {
    ...
    inline bool AudioDeviceBase::IsPlayback() const
    {
    ...
    inline void AudioDeviceBase::Pause()
    {
        SDL::PauseAudioDevice(get());
    }
    ...
    inline void AudioDeviceBase::Resume()
    {
        SDL::ResumeAudioDevice(get());
    }
    ...
    inline bool AudioDeviceBase::Paused() const
    {
    ...
    inline float AudioDeviceBase::GetGain() const
    {
    ...
    inline void AudioDeviceBase::SetGain(float gain)
    {
    ...
    inline void AudioDeviceBase::Close()
    {
        CloseAudioDevice(release());
    }
     ...
     * format at any time with SetAudioStreamFormat(). If the other end of the
     ...
     * @sa GetAudioStreamDevice
     */
    inline void BindAudioStreams(AudioDeviceRef devid, std::span<AudioStreamRef> streams)
    {
    ...
    inline void AudioDeviceBase::BindAudioStream(AudioStreamRef stream)
    {
    ...
    inline void AudioStreamBase::Unbind()
    {
        SDL::UnbindAudioStream(get());
    }
    ...
    inline AudioDeviceRef AudioStreamBase::GetDevice() const
    {
     ...
     * @sa DestroyAudioStream
     */
    inline AudioStream CreateAudioStream(const AudioSpec &src_spec, const AudioSpec &dst_spec)
    {
        return AudioStream(src_spec, dst_spec);
    }

    inline AudioStream::AudioStream(OptionalRef<const AudioSpec> src_spec, OptionalRef<const AudioSpec> dst_spec)
    ...
    inline AudioStream::AudioStream(AudioDeviceRef devid,
                                    ...
                                    void *userdata)
        : AudioStream(CheckError(SDL_OpenAudioDeviceStream(devid, spec, callback, userdata)))
    {
    }

    inline AudioStream::AudioStream(AudioDeviceRef devid, OptionalRef<const AudioSpec> spec, AudioStreamCB callback)
    {
    }
    ...
    inline PropertiesRef AudioStreamBase::GetProperties() const
    {
    ...
    namespace prop::AudioStream
    {
        ...
        constexpr auto AUTO_CLEANUP_BOOLEAN = SDL_PROP_AUDIOSTREAM_AUTO_CLEANUP_BOOLEAN; ///< Auto cleanup enabled.
     ...
     * @sa SetAudioStreamFormat
     */
    inline void GetAudioStreamFormat(AudioStreamRef stream, AudioSpec *src_spec, AudioSpec *dst_spec)
    {
        CheckError(SDL_GetAudioStreamFormat(stream, src_spec, dst_spec));
    }

    inline void AudioStreamBase::GetFormat(AudioSpec *src_spec, AudioSpec *dst_spec) const
    {
    ...
    inline void AudioStreamBase::SetFormat(OptionalRef<const AudioSpec> src_spec, OptionalRef<const AudioSpec> dst_spec)
    {
    ...
    inline float AudioStreamBase::GetFrequencyRatio() const
    {
     ...
     *
     * This is applied during GetAudioStreamData, and can be continuously changed to
    ...
    inline void AudioStreamBase::SetFrequencyRatio(float ratio)
    {
    ...
    inline float AudioStreamBase::GetGain() const
    {
    ...
    inline void AudioStreamBase::SetGain(float gain)
    {
    ...
    inline OwnArray<int> AudioStreamBase::GetInputChannelMap() const
    {
    ...
    inline OwnArray<int> AudioStreamBase::GetOutputChannelMap() const
    {
     ...
     * @sa SetAudioStreamOutputChannelMap
     */
    inline void SetAudioStreamInputChannelMap(AudioStreamRef stream, std::span<int> chmap)
    {
        CheckError(SDL_SetAudioStreamInputChannelMap(stream, chmap));
    }

    inline void AudioStreamBase::SetInputChannelMap(std::span<int> chmap)
    {
    ...
    inline void AudioStreamBase::SetOutputChannelMap(std::span<int> chmap)
    {
    ...
    inline void AudioStreamBase::PutData(SourceBytes buf)
    {
     ...
     * from the stream in its entirety, or a call to ClearAudioStream() or
     * DestroyAudioStream().
     *
     * The data must match the format/channels/samplerate specified in the latest
     * call to SetAudioStreamFormat, or the format specified when creating the
    ...
    inline void PutAudioStreamDataNoCopy(AudioStreamRef stream,
                                         ...
                                         void *userdata)
    {
        CheckError(SDL_PutAudioStreamDataNoCopy(stream, buf.data(), buf.size_bytes(), callback, userdata));
    }
     ...
     * @sa GetAudioStreamQueued
     */
    inline void PutAudioStreamDataNoCopy(AudioStreamRef stream, SourceBytes buf, AudioStreamDataCompleteCB callback)
    {
        static_assert(false, "Not implemented");
    }

    inline void AudioStreamBase::PutDataNoCopy(SourceBytes buf,
                                               AudioStreamDataCompleteCallback callback,
                                               void *userdata)
    {
    ...
    inline void AudioStreamBase::PutDataNoCopy(SourceBytes buf, AudioStreamDataCompleteCB callback)
    {
        SDL::PutAudioStreamDataNoCopy(get(), std::move(buf), callback);
    }
    ...
    inline void PutAudioStreamPlanarData(AudioStreamRef stream,
                                         ...
                                         int num_samples)
    {
        CheckError(SDL_PutAudioStreamPlanarData(stream, channel_buffers, num_channels, num_samples));
    }

    inline void AudioStreamBase::PutPlanarData(const void *const *channel_buffers, int num_channels, int num_samples)
    {
        SDL::PutAudioStreamPlanarData(get(), channel_buffers, num_channels, num_samples);
    }
    ...
    inline int AudioStreamBase::GetData(TargetBytes buf)
    {
     ...
     * GetAudioStreamData before this function's return value is no longer clamped.
     *
     * @param stream the audio stream to query.
    ...
    inline int AudioStreamBase::GetAvailable() const
    {
    ...
    inline int AudioStreamBase::GetQueued() const
    {
    ...
    inline void AudioStreamBase::Flush()
    {
        SDL::FlushAudioStream(get());
    }
    ...
    inline void AudioStreamBase::Clear()
    {
        SDL::ClearAudioStream(get());
    }
    ...
    inline void AudioStreamBase::PauseDevice()
    {
        SDL::PauseAudioStreamDevice(get());
    }
    ...
    inline void AudioStreamBase::ResumeDevice()
    {
        SDL::ResumeAudioStreamDevice(get());
    }
    ...
    inline bool AudioStreamBase::DevicePaused() const
    {
    ...
    {
        return {AudioStreamRef(*this)};
    }

    inline AudioStreamLock::AudioStreamLock(AudioStreamRef resource) : m_lock(std::move(resource))
    {
    ...
    inline void AudioStreamBase::Unlock(AudioStreamLock &&lock)
    {
     ...
     *
     * The callback can (optionally) call PutAudioStreamData() to add more audio to
     ...
     * @sa SetAudioStreamPutCallback
     */
    inline void SetAudioStreamGetCallback(AudioStreamRef stream, AudioStreamCallback callback, void *userdata)
    {
     ...
     * @sa SetAudioStreamPutCallback
     */
    inline void SetAudioStreamGetCallback(AudioStreamRef stream, AudioStreamCB callback)
    {
        static_assert(false, "Not implemented");
    }

    inline void AudioStreamBase::SetGetCallback(AudioStreamCallback callback, void *userdata)
    {
     ...
     * callback the chance to obtain it immediately.
     *
     * The callback can (optionally) call GetAudioStreamData() to obtain audio from
     ...
     * @sa SetAudioStreamGetCallback
     */
    inline void SetAudioStreamPutCallback(AudioStreamRef stream, AudioStreamCallback callback, void *userdata)
    {
    ...
    inline void AudioStreamBase::SetPutCallback(AudioStreamCallback callback, void *userdata)
    {
    ...
    inline void AudioStreamBase::Destroy()
    {
        DestroyAudioStream(release());
    }
     ...
     * format, and the app can use GetAudioStreamFormat() to obtain this information
     * later.
     *
     * If you don't care about opening a specific audio device, you can (and
     * probably _should_), use AUDIO_DEVICE_DEFAULT_PLAYBACK for playback and
     ...
     *                 case the app will need to call PutAudioStreamData or
     *                 GetAudioStreamData as necessary.
     * @param userdata app-controlled pointer passed to callback. Can be nullptr.
     *                 Ignored if callback is nullptr.
     * @returns an audio stream on success.
     * @throws Error on failure.
    ...
    inline AudioStreamRef AudioDeviceBase::OpenStream(const AudioSpec &spec,
                                                      AudioStreamCallback callback,
                                                      void *userdata)
    {
    ...
    inline AudioStream AudioDeviceBase::OpenStream(OptionalRef<const AudioSpec> spec, AudioStreamCB callback)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SetAudioPostmixCallback(AudioDeviceRef devid, AudioPostmixCallback callback, void *userdata)
    {
    ...
    inline void AudioDeviceBase::SetPostmixCallback(AudioPostmixCallback callback, void *userdata)
    {
     ...
     *
     * ```c
     * LoadWAV_IO(IOFromFile("sample.wav", "rb"), true, &spec, &buf, &len);
     * ```
     *
     ...
     * @sa LoadWAV
     */
    inline OwnArray<Uint8> LoadWAV_IO(IOStreamRef src, AudioSpec *spec, bool closeio = false)
    {
     ...
     *
     * ```c
     * LoadWAV_IO(IOFromFile(path, "rb"), true, spec, audio_buf, audio_len);
     * ```
     *
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void MixAudio(Uint8 *dst, SourceBytes src, AudioFormat format, float volume)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void MixAudio(TargetBytes dst, SourceBytes src, AudioFormat format, float volume)
    {
        static_assert(false, "Not implemented");
    }
    ...
    {
        return CheckError(SDL_ConvertAudioSamples(&src_spec, src_data.data(), src_data.size_bytes(), &dst_spec));
    }
