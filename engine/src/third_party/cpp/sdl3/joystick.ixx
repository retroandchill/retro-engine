...
namespace SDL
{
    ...
    constexpr JoystickType JOYSTICK_TYPE_UNKNOWN = SDL_JOYSTICK_TYPE_UNKNOWN; ///< JOYSTICK_TYPE_UNKNOWN

    constexpr JoystickType JOYSTICK_TYPE_GAMEPAD = SDL_JOYSTICK_TYPE_GAMEPAD; ///< JOYSTICK_TYPE_GAMEPAD

    constexpr JoystickType JOYSTICK_TYPE_WHEEL = SDL_JOYSTICK_TYPE_WHEEL; ///< JOYSTICK_TYPE_WHEEL

    constexpr JoystickType JOYSTICK_TYPE_ARCADE_STICK = SDL_JOYSTICK_TYPE_ARCADE_STICK; ///< JOYSTICK_TYPE_ARCADE_STICK

    constexpr JoystickType JOYSTICK_TYPE_FLIGHT_STICK = SDL_JOYSTICK_TYPE_FLIGHT_STICK; ///< JOYSTICK_TYPE_FLIGHT_STICK

    constexpr JoystickType JOYSTICK_TYPE_DANCE_PAD = SDL_JOYSTICK_TYPE_DANCE_PAD; ///< JOYSTICK_TYPE_DANCE_PAD

    constexpr JoystickType JOYSTICK_TYPE_GUITAR = SDL_JOYSTICK_TYPE_GUITAR; ///< JOYSTICK_TYPE_GUITAR

    constexpr JoystickType JOYSTICK_TYPE_DRUM_KIT = SDL_JOYSTICK_TYPE_DRUM_KIT; ///< JOYSTICK_TYPE_DRUM_KIT

    constexpr JoystickType JOYSTICK_TYPE_ARCADE_PAD = SDL_JOYSTICK_TYPE_ARCADE_PAD; ///< JOYSTICK_TYPE_ARCADE_PAD

    constexpr JoystickType JOYSTICK_TYPE_THROTTLE = SDL_JOYSTICK_TYPE_THROTTLE; ///< JOYSTICK_TYPE_THROTTLE

    constexpr JoystickType JOYSTICK_TYPE_COUNT = SDL_JOYSTICK_TYPE_COUNT; ///< JOYSTICK_TYPE_COUNT
    ...
    class JoystickID
    {
      ...
      public:
         ...
         */
        constexpr JoystickID(JoystickIDRaw joystickID = {}) noexcept : m_joystickID(joystickID)
        {
        }
    ...
    struct Joystick : JoystickBase
    {
         ...
         */
        constexpr explicit Joystick(JoystickRaw resource) noexcept : JoystickBase(resource)
        {
        }

        /// Move constructor
        constexpr Joystick(Joystick &&other) noexcept : Joystick(other.release())
        {
        }
    ...
    class JoystickApiLock
    {
      ...
      public:
        ...
        /// Move constructor
        JoystickApiLock(JoystickApiLock &&other) noexcept : m_lock(std::move(other.m_lock))
        {
        }
    ...
    inline JoystickApiLock::JoystickApiLock() : m_lock(true)
    {
        LockJoysticks();
    }
    ...
    inline Joystick::Joystick(JoystickID instance_id) : Joystick(SDL_OpenJoystick(instance_id))
    {
    }
     ...
     * @sa SDL_SetJoystickVirtualSensorData
     */
    inline void SetJoystickVirtualBall(JoystickRef joystick, int ball, Sint16 xrel, Sint16 yrel)
    {
     ...
     * @sa SDL_SetJoystickVirtualSensorData
     */
    inline void SetJoystickVirtualButton(JoystickRef joystick, int button, bool down)
    {
    ...
    inline void SetJoystickVirtualTouchpad(JoystickRef joystick,
                                           ...
                                           float pressure)
    {
        CheckError(SDL_SetJoystickVirtualTouchpad(joystick, touchpad, finger, down, p, pressure));
    }
    ...
    inline void SendJoystickVirtualSensorData(JoystickRef joystick,
                                              ...
                                              int num_values)
    {
        CheckError(SDL_SendJoystickVirtualSensorData(joystick, type, sensor_timestamp, data, num_values));
    }
    ...
    inline void JoystickBase::SendVirtualSensorData(SensorType type,
                                                    ...
                                                    int num_values)
    {
        SDL::SendJoystickVirtualSensorData(get(), type, sensor_timestamp, data, num_values);
    }
    ...
    namespace prop::JoystickCap
    {
        ...
        constexpr auto MONO_LED_BOOLEAN = SDL_PROP_JOYSTICK_CAP_MONO_LED_BOOLEAN; ///< Mono led enabled.

        constexpr auto RGB_LED_BOOLEAN = SDL_PROP_JOYSTICK_CAP_RGB_LED_BOOLEAN; ///< Rgb led enabled.

        constexpr auto PLAYER_LED_BOOLEAN = SDL_PROP_JOYSTICK_CAP_PLAYER_LED_BOOLEAN; ///< Player led enabled.

        constexpr auto RUMBLE_BOOLEAN = SDL_PROP_JOYSTICK_CAP_RUMBLE_BOOLEAN; ///< Rumble enabled.
    ...
    inline GUID JoystickBase::GetGUID()
    {
        return SDL::GetJoystickGUID(get());
    }
     ...
     * @sa GetJoystickGUIDForID
     */
    inline void GetJoystickGUIDInfo(GUID guid, Uint16 *vendor, Uint16 *product, Uint16 *version, Uint16 *crc16)
    {
    ...
    inline bool JoystickBase::Connected()
    {
        return SDL::JoystickConnected(get());
    }
    ...
    inline JoystickID JoystickBase::GetID()
    {
        return SDL::GetJoystickID(get());
    }
    ...
    inline int JoystickBase::GetNumAxes()
    {
        return SDL::GetNumJoystickAxes(get());
    }
    ...
    inline int JoystickBase::GetNumHats()
    {
        return SDL::GetNumJoystickHats(get());
    }
     ...
     */
    inline bool JoystickEventsEnabled()
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline bool GetJoystickAxisInitialState(JoystickRef joystick, int axis, Sint16 *state)
    {
    ...
    inline bool JoystickBase::Rumble(Uint16 low_frequency_rumble, Uint16 high_frequency_rumble, Uint32 duration_ms)
    {
        return SDL::RumbleJoystick(get(), low_frequency_rumble, high_frequency_rumble, duration_ms);
    }
    ...
    inline void RumbleJoystickTriggers(JoystickRef joystick,
                                       ...
                                       Uint32 duration_ms)
    {
        CheckError(SDL_RumbleJoystickTriggers(joystick, left_rumble, right_rumble, duration_ms));
    }

    inline void JoystickBase::RumbleTriggers(Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SetJoystickLED(JoystickRef joystick, Uint8 red, Uint8 green, Uint8 blue)
    {
     ...
     * @sa OpenJoystick
     */
    inline void CloseJoystick(JoystickRaw joystick)
    {
        SDL_CloseJoystick(joystick);
    }

    inline void JoystickBase::Close()
    {
        CloseJoystick(release());
    }
