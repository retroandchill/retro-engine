...
#define SDL_disabled_assert(condition)                                                                                 \
    ...
    constexpr AssertState ASSERTION_RETRY = SDL_ASSERTION_RETRY; ///< Retry the assert immediately.

    constexpr AssertState ASSERTION_BREAK = SDL_ASSERTION_BREAK; ///< Make the debugger trigger a breakpoint.

    constexpr AssertState ASSERTION_ABORT = SDL_ASSERTION_ABORT; ///< Terminate the program.

    constexpr AssertState ASSERTION_IGNORE = SDL_ASSERTION_IGNORE; ///< Ignore the assert.

    constexpr AssertState ASSERTION_ALWAYS_IGNORE = SDL_ASSERTION_ALWAYS_IGNORE; ///< Ignore the assert from now on.
     ...
     */
    inline AssertState ReportAssertion(AssertData *data, StringParam func, StringParam file, int line)
    {
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            const SDL_AssertState sdl_assert_state =                                                                   \
                SDL_ReportAssertion(&sdl_assert_data, SDL_FUNCTION, SDL_ASSERT_FILE, SDL_LINE);                        \
...
#define SDL_assert_always(condition) SDL_enabled_assert(condition)
     ...
     */
    using AssertionHandler = AssertState(SDLCALL *)(const AssertData *data, void *userdata);
     ...
     * @sa AssertionHandler
     */
    using AssertionHandlerCB = MakeTrailingCallback<AssertState(const AssertData *data)>;
