...
export module sdl:callbackWrapper;
...
namespace SDL
{
     ...
     */
    export template <class SELF, class R, class... PARAMS>
    ...
    struct MakeFrontCallback<R(PARAMS...)> : LightweightCallbackT<MakeFrontCallback<R(PARAMS...)>, R, PARAMS...>
    {
        /// ctor
        template <std::invocable<PARAMS...> F>
        MakeFrontCallback(const F &func) : LightweightCallbackT<MakeFrontCallback<R(PARAMS...)>, R, PARAMS...>(func)
        {
        }
    ...
    struct MakeTrailingCallback<R(PARAMS...)>
        : LightweightTrailingCallbackT<MakeTrailingCallback<R(PARAMS...)>, R, PARAMS...>
    {
        /// ctor
        template <std::invocable<PARAMS...> F>
        MakeTrailingCallback(const F &func)
            : LightweightTrailingCallbackT<MakeTrailingCallback<R(PARAMS...)>, R, PARAMS...>(func)
        {
        }
