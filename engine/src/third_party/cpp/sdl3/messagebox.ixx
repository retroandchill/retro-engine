...
namespace SDL
{
    ...
    constexpr MessageBoxFlags MESSAGEBOX_ERROR = SDL_MESSAGEBOX_ERROR; ///< error dialog

    constexpr MessageBoxFlags MESSAGEBOX_WARNING = SDL_MESSAGEBOX_WARNING; ///< warning dialog

    constexpr MessageBoxFlags MESSAGEBOX_INFORMATION = SDL_MESSAGEBOX_INFORMATION; ///< informational dialog
    ...
    constexpr MessageBoxColorType MESSAGEBOX_COLOR_BACKGROUND = SDL_MESSAGEBOX_COLOR_BACKGROUND; ///< BACKGROUND

    constexpr MessageBoxColorType MESSAGEBOX_COLOR_TEXT = SDL_MESSAGEBOX_COLOR_TEXT; ///< TEXT
    ...
    constexpr MessageBoxColorType MESSAGEBOX_COLOR_COUNT =
        SDL_MESSAGEBOX_COLOR_COUNT; ///< Size of the colors array of MessageBoxColorScheme.
    ...
    struct MessageBox : MessageBoxRaw
    {
         ...
         */
        constexpr MessageBox(const MessageBoxRaw &messageBox = {}) noexcept : MessageBoxRaw(messageBox)
        {
        }
        ...
        constexpr MessageBox(MessageBoxFlags flags,
                             ...
                             const MessageBoxColorScheme &colorScheme) noexcept
            : MessageBoxRaw{flags, window, title, message, numbuttons, buttons, colorScheme}
        {
        }
         ...
         * @returns Reference to self.
         */
        constexpr MessageBox &SetTitle(StringParam newTitle) noexcept
        {
            title = newTitle;
            return *this;
        }
         ...
         * @returns Reference to self.
         */
        constexpr MessageBox &SetMessage(StringParam newMessage) noexcept
        {
            message = newMessage;
            return *this;
        }
         ...
         */
        constexpr const MessageBoxButtonData &GetButtons() const noexcept
        {
            return buttons;
        }
         ...
         * @returns Reference to self.
         */
        constexpr MessageBox &SetButtons(const MessageBoxButtonData &newButtons) noexcept
        {
            buttons = newButtons;
            return *this;
        }
         ...
         * @returns Reference to self.
         */
        constexpr MessageBox &SetColorScheme(const MessageBoxColorScheme &newColorScheme) noexcept
        {
     ...
     * @sa ShowMessageBox
     */
    inline void ShowSimpleMessageBox(MessageBoxFlags flags, StringParam title, StringParam message, WindowRef window)
    {
