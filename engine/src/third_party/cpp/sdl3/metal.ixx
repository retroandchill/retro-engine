...
namespace SDL
{
    ...
    struct MetalView : MetalViewBase
    {
         ...
         */
        constexpr explicit MetalView(MetalViewRaw resource) noexcept : MetalViewBase(resource)
        {
        }

        /// Move constructor
        constexpr MetalView(MetalView &&other) noexcept : MetalView(other.release())
        {
        }
    ...
    inline MetalView::MetalView(WindowRef window) : MetalView(SDL_Metal_CreateView(window))
    {
    }
     ...
     * @sa Metal_CreateView
     */
    inline void Metal_DestroyView(MetalViewRef view, MetalViewRef view)
    {
        Metal_DestroyView(release());
    }

    inline void MetalViewBase::Metal_DestroyView()
    {
        Metal_DestroyView(release());
    }
    ...
    inline void *MetalViewBase::GetLayer()
    {
        return SDL::Metal_GetLayer(get());
    }
