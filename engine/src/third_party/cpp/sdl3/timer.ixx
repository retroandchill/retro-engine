...
namespace SDL
{
    ...
    {
        return SDL_SECONDS_TO_NS(time);
    }

    constexpr Sint64 Time::ToPosix() const
    {
        return SDL_NS_TO_SECONDS(m_time);
    }
     ...
     * @sa AddTimer
     */
    using MSTimerCallback = Uint32(SDLCALL *)(void *userdata, TimerID timerID, Uint32 interval);
     ...
     * @sa AddTimer
     */
    using NSTimerCallback = Uint64(SDLCALL *)(void *userdata, TimerID timerID, Uint64 interval);
    ...
    struct TimerCB : LightweightCallbackT<TimerCB, Uint64, TimerID, Uint64>
    {
        ...
        TimerCB(const F &func) : LightweightCallbackT<TimerCB, Uint64, TimerID, Uint64>(func)
        {
        }
     ...
     * @param callback the MSTimerCallback function to call when the specified
     *                 `interval` elapses.
     ...
     * @sa RemoveTimer
     */
    inline TimerID AddTimer(std::chrono::milliseconds interval, MSTimerCallback callback, void *userdata)
    {
     ...
     * @sa RemoveTimer
     */
    inline TimerID AddTimer(std::chrono::nanoseconds interval, NSTimerCallback callback, void *userdata)
    {
