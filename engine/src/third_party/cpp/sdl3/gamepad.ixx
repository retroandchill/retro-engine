...
namespace SDL
{
    ...
    constexpr GamepadType GAMEPAD_TYPE_UNKNOWN = SDL_GAMEPAD_TYPE_UNKNOWN; ///< GAMEPAD_TYPE_UNKNOWN

    constexpr GamepadType GAMEPAD_TYPE_STANDARD = SDL_GAMEPAD_TYPE_STANDARD; ///< GAMEPAD_TYPE_STANDARD

    constexpr GamepadType GAMEPAD_TYPE_XBOX360 = SDL_GAMEPAD_TYPE_XBOX360; ///< GAMEPAD_TYPE_XBOX360

    constexpr GamepadType GAMEPAD_TYPE_XBOXONE = SDL_GAMEPAD_TYPE_XBOXONE; ///< GAMEPAD_TYPE_XBOXONE

    constexpr GamepadType GAMEPAD_TYPE_PS3 = SDL_GAMEPAD_TYPE_PS3; ///< GAMEPAD_TYPE_PS3

    constexpr GamepadType GAMEPAD_TYPE_PS4 = SDL_GAMEPAD_TYPE_PS4; ///< GAMEPAD_TYPE_PS4

    constexpr GamepadType GAMEPAD_TYPE_PS5 = SDL_GAMEPAD_TYPE_PS5; ///< GAMEPAD_TYPE_PS5
    ...
    constexpr GamepadType GAMEPAD_TYPE_GAMECUBE = SDL_GAMEPAD_TYPE_GAMECUBE; ///< GAMEPAD_TYPE_GAMECUBE

#endif // SDL_VERSION_ATLEAST(3, 4, 0)

    constexpr GamepadType GAMEPAD_TYPE_COUNT = SDL_GAMEPAD_TYPE_COUNT; ///< GAMEPAD_TYPE_COUNT
    ...
    constexpr GamepadButton GAMEPAD_BUTTON_INVALID = SDL_GAMEPAD_BUTTON_INVALID; ///< GAMEPAD_BUTTON_INVALID

    constexpr GamepadButton GAMEPAD_BUTTON_SOUTH =
        SDL_GAMEPAD_BUTTON_SOUTH; ///< Bottom face button (e.g. Xbox A button)

    constexpr GamepadButton GAMEPAD_BUTTON_EAST = SDL_GAMEPAD_BUTTON_EAST; ///< Right face button (e.g. Xbox B button)

    constexpr GamepadButton GAMEPAD_BUTTON_WEST = SDL_GAMEPAD_BUTTON_WEST; ///< Left face button (e.g. Xbox X button)

    constexpr GamepadButton GAMEPAD_BUTTON_NORTH = SDL_GAMEPAD_BUTTON_NORTH; ///< Top face button (e.g. Xbox Y button)

    constexpr GamepadButton GAMEPAD_BUTTON_BACK = SDL_GAMEPAD_BUTTON_BACK; ///< GAMEPAD_BUTTON_BACK

    constexpr GamepadButton GAMEPAD_BUTTON_GUIDE = SDL_GAMEPAD_BUTTON_GUIDE; ///< GAMEPAD_BUTTON_GUIDE

    constexpr GamepadButton GAMEPAD_BUTTON_START = SDL_GAMEPAD_BUTTON_START; ///< GAMEPAD_BUTTON_START

    constexpr GamepadButton GAMEPAD_BUTTON_LEFT_STICK = SDL_GAMEPAD_BUTTON_LEFT_STICK; ///< GAMEPAD_BUTTON_LEFT_STICK

    constexpr GamepadButton GAMEPAD_BUTTON_RIGHT_STICK = SDL_GAMEPAD_BUTTON_RIGHT_STICK; ///< GAMEPAD_BUTTON_RIGHT_STICK
    ...
    constexpr GamepadButton GAMEPAD_BUTTON_DPAD_UP = SDL_GAMEPAD_BUTTON_DPAD_UP; ///< GAMEPAD_BUTTON_DPAD_UP

    constexpr GamepadButton GAMEPAD_BUTTON_DPAD_DOWN = SDL_GAMEPAD_BUTTON_DPAD_DOWN; ///< GAMEPAD_BUTTON_DPAD_DOWN

    constexpr GamepadButton GAMEPAD_BUTTON_DPAD_LEFT = SDL_GAMEPAD_BUTTON_DPAD_LEFT; ///< GAMEPAD_BUTTON_DPAD_LEFT

    constexpr GamepadButton GAMEPAD_BUTTON_DPAD_RIGHT = SDL_GAMEPAD_BUTTON_DPAD_RIGHT; ///< GAMEPAD_BUTTON_DPAD_RIGHT
     ...
     */
    constexpr GamepadButton GAMEPAD_BUTTON_RIGHT_PADDLE1 = SDL_GAMEPAD_BUTTON_RIGHT_PADDLE1;

    /**
     * Upper or primary paddle, under your left hand (e.g. Xbox Elite paddle P3,
     * DualSense Edge LB button, Left Joy-Con SL button)
     */
    constexpr GamepadButton GAMEPAD_BUTTON_LEFT_PADDLE1 = SDL_GAMEPAD_BUTTON_LEFT_PADDLE1;
     ...
     */
    constexpr GamepadButton GAMEPAD_BUTTON_RIGHT_PADDLE2 = SDL_GAMEPAD_BUTTON_RIGHT_PADDLE2;
     ...
     */
    constexpr GamepadButton GAMEPAD_BUTTON_LEFT_PADDLE2 = SDL_GAMEPAD_BUTTON_LEFT_PADDLE2;

    constexpr GamepadButton GAMEPAD_BUTTON_TOUCHPAD = SDL_GAMEPAD_BUTTON_TOUCHPAD; ///< PS4/PS5 touchpad button

    constexpr GamepadButton GAMEPAD_BUTTON_MISC2 = SDL_GAMEPAD_BUTTON_MISC2; ///< Additional button
    ...
    constexpr GamepadButton GAMEPAD_BUTTON_MISC5 = SDL_GAMEPAD_BUTTON_MISC5; ///< Additional button

    constexpr GamepadButton GAMEPAD_BUTTON_MISC6 = SDL_GAMEPAD_BUTTON_MISC6; ///< Additional button

    constexpr GamepadButton GAMEPAD_BUTTON_COUNT = SDL_GAMEPAD_BUTTON_COUNT; ///< GAMEPAD_BUTTON_COUNT
    ...
    constexpr GamepadButtonLabel GAMEPAD_BUTTON_LABEL_A = SDL_GAMEPAD_BUTTON_LABEL_A; ///< GAMEPAD_BUTTON_LABEL_A

    constexpr GamepadButtonLabel GAMEPAD_BUTTON_LABEL_B = SDL_GAMEPAD_BUTTON_LABEL_B; ///< GAMEPAD_BUTTON_LABEL_B

    constexpr GamepadButtonLabel GAMEPAD_BUTTON_LABEL_X = SDL_GAMEPAD_BUTTON_LABEL_X; ///< GAMEPAD_BUTTON_LABEL_X

    constexpr GamepadButtonLabel GAMEPAD_BUTTON_LABEL_Y = SDL_GAMEPAD_BUTTON_LABEL_Y; ///< GAMEPAD_BUTTON_LABEL_Y
    ...
    constexpr GamepadAxis GAMEPAD_AXIS_INVALID = SDL_GAMEPAD_AXIS_INVALID; ///< GAMEPAD_AXIS_INVALID

    constexpr GamepadAxis GAMEPAD_AXIS_LEFTX = SDL_GAMEPAD_AXIS_LEFTX; ///< GAMEPAD_AXIS_LEFTX

    constexpr GamepadAxis GAMEPAD_AXIS_LEFTY = SDL_GAMEPAD_AXIS_LEFTY; ///< GAMEPAD_AXIS_LEFTY

    constexpr GamepadAxis GAMEPAD_AXIS_RIGHTX = SDL_GAMEPAD_AXIS_RIGHTX; ///< GAMEPAD_AXIS_RIGHTX

    constexpr GamepadAxis GAMEPAD_AXIS_RIGHTY = SDL_GAMEPAD_AXIS_RIGHTY; ///< GAMEPAD_AXIS_RIGHTY

    constexpr GamepadAxis GAMEPAD_AXIS_LEFT_TRIGGER = SDL_GAMEPAD_AXIS_LEFT_TRIGGER; ///< GAMEPAD_AXIS_LEFT_TRIGGER

    constexpr GamepadAxis GAMEPAD_AXIS_RIGHT_TRIGGER = SDL_GAMEPAD_AXIS_RIGHT_TRIGGER; ///< GAMEPAD_AXIS_RIGHT_TRIGGER

    constexpr GamepadAxis GAMEPAD_AXIS_COUNT = SDL_GAMEPAD_AXIS_COUNT; ///< GAMEPAD_AXIS_COUNT
    ...
    constexpr GamepadBindingType GAMEPAD_BINDTYPE_NONE = SDL_GAMEPAD_BINDTYPE_NONE; ///< GAMEPAD_BINDTYPE_NONE

    constexpr GamepadBindingType GAMEPAD_BINDTYPE_BUTTON = SDL_GAMEPAD_BINDTYPE_BUTTON; ///< GAMEPAD_BINDTYPE_BUTTON

    constexpr GamepadBindingType GAMEPAD_BINDTYPE_AXIS = SDL_GAMEPAD_BINDTYPE_AXIS; ///< GAMEPAD_BINDTYPE_AXIS

    constexpr GamepadBindingType GAMEPAD_BINDTYPE_HAT = SDL_GAMEPAD_BINDTYPE_HAT; ///< GAMEPAD_BINDTYPE_HAT
    ...
    struct Gamepad : GamepadBase
    {
         ...
         */
        constexpr explicit Gamepad(GamepadRaw resource) noexcept : GamepadBase(resource)
        {
        }

        /// Move constructor
        constexpr Gamepad(Gamepad &&other) noexcept : Gamepad(other.release())
        {
        }
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void ReloadGamepadMappings()
    {
        CheckError(SDL_ReloadGamepadMappings());
    }
    ...
    inline Gamepad::Gamepad(JoystickID instance_id) : Gamepad(SDL_OpenGamepad(instance_id))
    {
    }
    ...
    namespace prop::GamepadCap
    {
        ...
        constexpr auto MONO_LED_BOOLEAN = SDL_PROP_GAMEPAD_CAP_MONO_LED_BOOLEAN; ///< Mono led enabled.

        constexpr auto RGB_LED_BOOLEAN = SDL_PROP_GAMEPAD_CAP_RGB_LED_BOOLEAN; ///< Rgb led enabled.

        constexpr auto PLAYER_LED_BOOLEAN = SDL_PROP_GAMEPAD_CAP_PLAYER_LED_BOOLEAN; ///< Player led enabled.

        constexpr auto RUMBLE_BOOLEAN = SDL_PROP_GAMEPAD_CAP_RUMBLE_BOOLEAN; ///< Rumble enabled.
    ...
    inline JoystickID GamepadBase::GetID()
    {
        return SDL::GetGamepadID(get());
    }
    ...
    inline const char *GamepadBase::GetName()
    {
        return SDL::GetGamepadName(get());
    }
    ...
    inline const char *GamepadBase::GetPath()
    {
        return SDL::GetGamepadPath(get());
    }
    ...
    inline GamepadType GamepadBase::GetType()
    {
        return SDL::GetGamepadType(get());
    }
    ...
    inline Uint16 GamepadBase::GetVendor()
    {
        return SDL::GetGamepadVendor(get());
    }
    ...
    inline bool GamepadBase::Connected()
    {
        return SDL::GamepadConnected(get());
    }
     ...
     */
    inline bool GamepadEventsEnabled()
    {
     ...
     */
    inline GamepadButtonLabel GetGamepadButtonLabelForType(GamepadType type, GamepadButton button)
    {
     ...
     * @sa GetGamepadButtonLabelForType
     */
    inline GamepadButtonLabel GetGamepadButtonLabel(GamepadRef gamepad, GamepadButton button)
    {
    ...
    inline void GetGamepadTouchpadFinger(GamepadRef gamepad,
                                         ...
                                         float *pressure)
    {
        CheckError(SDL_GetGamepadTouchpadFinger(gamepad, touchpad, finger, down, x, y, pressure));
    }
     ...
     * @sa GamepadSensorEnabled
     */
    inline void SetGamepadSensorEnabled(GamepadRef gamepad, SensorType type, bool enabled)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void GetGamepadSensorData(GamepadRef gamepad, SensorType type, float *data, int num_values)
    {
        CheckError(SDL_GetGamepadSensorData(gamepad, type, data, num_values));
    }

    inline void GamepadBase::GetSensorData(SensorType type, float *data, int num_values)
    {
    ...
    inline void RumbleGamepad(GamepadRef gamepad,
                              ...
                              Uint32 duration_ms)
    {
        CheckError(SDL_RumbleGamepad(gamepad, low_frequency_rumble, high_frequency_rumble, duration_ms));
    }

    inline void GamepadBase::Rumble(Uint16 low_frequency_rumble, Uint16 high_frequency_rumble, Uint32 duration_ms)
    {
        SDL::RumbleGamepad(get(), low_frequency_rumble, high_frequency_rumble, duration_ms);
    }
     ...
     * @sa RumbleGamepad
     */
    inline void RumbleGamepadTriggers(GamepadRef gamepad, Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms)
    {
        CheckError(SDL_RumbleGamepadTriggers(gamepad, left_rumble, right_rumble, duration_ms));
    }

    inline void GamepadBase::RumbleTriggers(Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SetGamepadLED(GamepadRef gamepad, Uint8 red, Uint8 green, Uint8 blue)
    {
     ...
     * @sa OpenGamepad
     */
    inline void CloseGamepad(GamepadRaw gamepad)
    {
        SDL_CloseGamepad(gamepad);
    }

    inline void GamepadBase::Close()
    {
        CloseGamepad(release());
    }
     ...
     * @sa GetGamepadAppleSFSymbolsNameForAxis
     */
    inline const char *GetGamepadAppleSFSymbolsNameForButton(GamepadRef gamepad, GamepadButton button)
    {
        return SDL_GetGamepadAppleSFSymbolsNameForButton(gamepad, button);
    }

    inline const char *GamepadBase::GetAppleSFSymbolsNameForButton(GamepadButton button)
    {
     ...
     * @sa GetGamepadAppleSFSymbolsNameForButton
     */
    inline const char *GetGamepadAppleSFSymbolsNameForAxis(GamepadRef gamepad, GamepadAxis axis)
    {
