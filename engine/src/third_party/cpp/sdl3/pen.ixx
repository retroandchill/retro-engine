...
namespace SDL
{
    ...
    /**
     * @defgroup CategoryPen Category Pen
     *
    ...
    constexpr PenInputFlags PEN_INPUT_BUTTON_1 = SDL_PEN_INPUT_BUTTON_1; ///< button 1 is pressed
    ...
    constexpr PenAxis PEN_AXIS_PRESSURE = SDL_PEN_AXIS_PRESSURE; ///< Pen pressure. Unidirectional: 0 to 1.0
    ...
    constexpr PenAxis PEN_AXIS_TANGENTIAL_PRESSURE = SDL_PEN_AXIS_TANGENTIAL_PRESSURE;
    ...
    constexpr PenDeviceType PEN_DEVICE_TYPE_INVALID = SDL_PEN_DEVICE_TYPE_INVALID; ///< Not a valid pen device.

    constexpr PenDeviceType PEN_DEVICE_TYPE_UNKNOWN =
        SDL_PEN_DEVICE_TYPE_UNKNOWN; ///< Don't know specifics of this pen.

    constexpr PenDeviceType PEN_DEVICE_TYPE_DIRECT = SDL_PEN_DEVICE_TYPE_DIRECT; ///< Pen touches display.
