...
namespace SDL
{
    ...
    constexpr InitFlags INIT_AUDIO = SDL_INIT_AUDIO; ///< `INIT_AUDIO` implies `INIT_EVENTS`
    ...
    constexpr InitFlags INIT_JOYSTICK = SDL_INIT_JOYSTICK; ///< `INIT_JOYSTICK` implies `INIT_EVENTS`

    constexpr InitFlags INIT_HAPTIC = SDL_INIT_HAPTIC; ///< HAPTIC

    constexpr InitFlags INIT_GAMEPAD = SDL_INIT_GAMEPAD; ///< `INIT_GAMEPAD` implies `INIT_JOYSTICK`

    constexpr InitFlags INIT_EVENTS = SDL_INIT_EVENTS; ///< EVENTS

    constexpr InitFlags INIT_SENSOR = SDL_INIT_SENSOR; ///< `INIT_SENSOR` implies `INIT_EVENTS`

    constexpr InitFlags INIT_CAMERA = SDL_INIT_CAMERA; ///< `INIT_CAMERA` implies `INIT_EVENTS`
     ...
     * @since This datatype is available since SDL 3.2.0.
     */
    using AppInit_func = AppResult(SDLCALL *)(void **appstate, int argc, char *argv[]);
     ...
     * @sa Quit
     */
    inline void QuitSubSystem(InitFlags flags)
    {
     ...
     * @sa InitSubSystem
     */
    inline InitFlags WasInit(InitFlags flags)
    {
     ...
     * @sa IsMainThread
     */
    inline void RunOnMainThread(MainThreadCallback callback, void *userdata, bool wait_complete)
    {
     ...
     * @sa SetAppMetadataProperty
     */
    inline void SetAppMetadata(StringParam appname, StringParam appversion, StringParam appidentifier)
    {
     ...
     *   default.
     * - `prop.appMetaData.URL_STRING`: A URL to the app on the web. Maybe a product
     *   page, or a storefront, or even a GitHub repository, for user's further
     *   information This has no default.
    ...
    namespace prop::appMetaData
    {
        ...
        constexpr auto NAME_STRING = SDL_PROP_APP_METADATA_NAME_STRING; ///< String for name.

        constexpr auto VERSION_STRING = SDL_PROP_APP_METADATA_VERSION_STRING; ///< String for version.

        constexpr auto IDENTIFIER_STRING = SDL_PROP_APP_METADATA_IDENTIFIER_STRING; ///< String for identifier.

        constexpr auto CREATOR_STRING = SDL_PROP_APP_METADATA_CREATOR_STRING; ///< String for creator.

        constexpr auto COPYRIGHT_STRING = SDL_PROP_APP_METADATA_COPYRIGHT_STRING; ///< String for copyright.

        constexpr auto URL_STRING = SDL_PROP_APP_METADATA_URL_STRING; ///< String for url.

        constexpr auto TYPE_STRING = SDL_PROP_APP_METADATA_TYPE_STRING; ///< String for type.
