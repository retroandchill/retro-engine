...
namespace SDL
{
    ...
    constexpr Folder FOLDER_SAVEDGAMES = SDL_FOLDER_SAVEDGAMES; ///< Save files for games.

    constexpr Folder FOLDER_SCREENSHOTS = SDL_FOLDER_SCREENSHOTS; ///< Application screenshots.
    ...
    struct PathInfo : PathInfoRaw
    {
         ...
         */
        constexpr PathInfo(const PathInfoRaw &pathInfo = {}) noexcept : PathInfoRaw(pathInfo)
        {
        }
     ...
     *
     * @sa GlobDirectory
     * @sa GlobStorageDirectory
     */
    using GlobFlags = Uint32;

    constexpr GlobFlags GLOB_CASEINSENSITIVE = SDL_GLOB_CASEINSENSITIVE; ///< CASEINSENSITIVE
    ...
    constexpr EnumerationResult ENUM_CONTINUE = SDL_ENUM_CONTINUE; ///< Value that requests that enumeration continue.
     ...
     */
    using EnumerateDirectoryCallback = EnumerationResult(SDLCALL *)(void *userdata,
                                                                    const char *dirname,
                                                                    const char *fname);
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void EnumerateDirectory(StringParam path, EnumerateDirectoryCallback callback, void *userdata)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void RemovePath(StringParam path)
    {
        CheckError(SDL_RemovePath(path));
    }
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline OwnArray<char *> GlobDirectory(StringParam path, StringParam pattern, GlobFlags flags)
    {
