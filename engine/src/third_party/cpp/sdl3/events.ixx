...
namespace SDL
{
     ...
     */
    constexpr EventType EVENT_WILL_ENTER_BACKGROUND = SDL_EVENT_WILL_ENTER_BACKGROUND;
     ...
     */
    constexpr EventType EVENT_WILL_ENTER_FOREGROUND = SDL_EVENT_WILL_ENTER_FOREGROUND;
    ...
    constexpr EventType EVENT_SYSTEM_THEME_CHANGED = SDL_EVENT_SYSTEM_THEME_CHANGED; ///< The system theme changed

    constexpr EventType EVENT_DISPLAY_ORIENTATION =
        SDL_EVENT_DISPLAY_ORIENTATION; ///< Display orientation has changed to data1

    constexpr EventType EVENT_DISPLAY_ADDED = SDL_EVENT_DISPLAY_ADDED; ///< Display has been added to the system

    constexpr EventType EVENT_DISPLAY_REMOVED = SDL_EVENT_DISPLAY_REMOVED; ///< Display has been removed from the system

    constexpr EventType EVENT_DISPLAY_MOVED = SDL_EVENT_DISPLAY_MOVED; ///< Display has changed position
    ...
    constexpr EventType EVENT_DISPLAY_FIRST = SDL_EVENT_DISPLAY_FIRST; ///< DISPLAY_FIRST

    constexpr EventType EVENT_DISPLAY_LAST = SDL_EVENT_DISPLAY_LAST; ///< DISPLAY_LAST

    constexpr EventType EVENT_WINDOW_SHOWN = SDL_EVENT_WINDOW_SHOWN; ///< Window has been shown

    constexpr EventType EVENT_WINDOW_HIDDEN = SDL_EVENT_WINDOW_HIDDEN; ///< Window has been hidden
    ...
    constexpr EventType EVENT_WINDOW_MOVED = SDL_EVENT_WINDOW_MOVED; ///< Window has been moved to data1, data2

    constexpr EventType EVENT_WINDOW_RESIZED = SDL_EVENT_WINDOW_RESIZED; ///< Window has been resized to data1xdata2

    /// The pixel size of the window has changed to data1xdata2
    constexpr EventType EVENT_WINDOW_PIXEL_SIZE_CHANGED = SDL_EVENT_WINDOW_PIXEL_SIZE_CHANGED;

    /// The pixel size of a Metal view associated with the window has changed
    constexpr EventType EVENT_WINDOW_METAL_VIEW_RESIZED = SDL_EVENT_WINDOW_METAL_VIEW_RESIZED;

    constexpr EventType EVENT_WINDOW_MINIMIZED = SDL_EVENT_WINDOW_MINIMIZED; ///< Window has been minimized

    constexpr EventType EVENT_WINDOW_MAXIMIZED = SDL_EVENT_WINDOW_MAXIMIZED; ///< Window has been maximized

    /// Window has been restored to normal size and position
    constexpr EventType EVENT_WINDOW_RESTORED = SDL_EVENT_WINDOW_RESTORED;

    constexpr EventType EVENT_WINDOW_MOUSE_ENTER = SDL_EVENT_WINDOW_MOUSE_ENTER; ///< Window has gained mouse focus

    constexpr EventType EVENT_WINDOW_MOUSE_LEAVE = SDL_EVENT_WINDOW_MOUSE_LEAVE; ///< Window has lost mouse focus

    constexpr EventType EVENT_WINDOW_FOCUS_GAINED = SDL_EVENT_WINDOW_FOCUS_GAINED; ///< Window has gained keyboard focus

    constexpr EventType EVENT_WINDOW_FOCUS_LOST = SDL_EVENT_WINDOW_FOCUS_LOST; ///< Window has lost keyboard focus

    /// The window manager requests that the window be closed
    constexpr EventType EVENT_WINDOW_CLOSE_REQUESTED = SDL_EVENT_WINDOW_CLOSE_REQUESTED;

    constexpr EventType EVENT_WINDOW_HIT_TEST =
        SDL_EVENT_WINDOW_HIT_TEST; ///< Window had a hit test that wasn't HITTEST_NORMAL

    /// The ICC profile of the window's display has changed
    constexpr EventType EVENT_WINDOW_ICCPROF_CHANGED = SDL_EVENT_WINDOW_ICCPROF_CHANGED;
    ...
    constexpr EventType EVENT_WINDOW_OCCLUDED = SDL_EVENT_WINDOW_OCCLUDED; ///< The window has been occluded
    ...
    constexpr EventType EVENT_WINDOW_FIRST = SDL_EVENT_WINDOW_FIRST; ///< WINDOW_FIRST
    ...
    constexpr EventType EVENT_TEXT_EDITING = SDL_EVENT_TEXT_EDITING; ///< Keyboard text editing (composition)

    constexpr EventType EVENT_TEXT_INPUT = SDL_EVENT_TEXT_INPUT; ///< Keyboard text input
    ...
    constexpr EventType EVENT_KEYBOARD_REMOVED = SDL_EVENT_KEYBOARD_REMOVED; ///< A keyboard has been removed
    ...
    constexpr EventType EVENT_MOUSE_MOTION = SDL_EVENT_MOUSE_MOTION; ///< Mouse moved

    constexpr EventType EVENT_MOUSE_BUTTON_DOWN = SDL_EVENT_MOUSE_BUTTON_DOWN; ///< Mouse button pressed

    constexpr EventType EVENT_MOUSE_BUTTON_UP = SDL_EVENT_MOUSE_BUTTON_UP; ///< Mouse button released

    constexpr EventType EVENT_MOUSE_WHEEL = SDL_EVENT_MOUSE_WHEEL; ///< Mouse wheel motion

    constexpr EventType EVENT_MOUSE_ADDED = SDL_EVENT_MOUSE_ADDED; ///< A new mouse has been inserted into the system

    constexpr EventType EVENT_MOUSE_REMOVED = SDL_EVENT_MOUSE_REMOVED; ///< A mouse has been removed

    constexpr EventType EVENT_JOYSTICK_AXIS_MOTION = SDL_EVENT_JOYSTICK_AXIS_MOTION; ///< Joystick axis motion

    constexpr EventType EVENT_JOYSTICK_BALL_MOTION = SDL_EVENT_JOYSTICK_BALL_MOTION; ///< Joystick trackball motion

    constexpr EventType EVENT_JOYSTICK_HAT_MOTION = SDL_EVENT_JOYSTICK_HAT_MOTION; ///< Joystick hat position change

    constexpr EventType EVENT_JOYSTICK_BUTTON_DOWN = SDL_EVENT_JOYSTICK_BUTTON_DOWN; ///< Joystick button pressed

    constexpr EventType EVENT_JOYSTICK_BUTTON_UP = SDL_EVENT_JOYSTICK_BUTTON_UP; ///< Joystick button released

    constexpr EventType EVENT_JOYSTICK_ADDED =
        SDL_EVENT_JOYSTICK_ADDED; ///< A new joystick has been inserted into the system

    constexpr EventType EVENT_JOYSTICK_REMOVED = SDL_EVENT_JOYSTICK_REMOVED; ///< An opened joystick has been removed
    ...
    constexpr EventType EVENT_GAMEPAD_AXIS_MOTION = SDL_EVENT_GAMEPAD_AXIS_MOTION; ///< Gamepad axis motion

    constexpr EventType EVENT_GAMEPAD_BUTTON_DOWN = SDL_EVENT_GAMEPAD_BUTTON_DOWN; ///< Gamepad button pressed

    constexpr EventType EVENT_GAMEPAD_BUTTON_UP = SDL_EVENT_GAMEPAD_BUTTON_UP; ///< Gamepad button released

    constexpr EventType EVENT_GAMEPAD_ADDED =
        SDL_EVENT_GAMEPAD_ADDED; ///< A new gamepad has been inserted into the system

    constexpr EventType EVENT_GAMEPAD_REMOVED = SDL_EVENT_GAMEPAD_REMOVED; ///< A gamepad has been removed

    constexpr EventType EVENT_GAMEPAD_REMAPPED = SDL_EVENT_GAMEPAD_REMAPPED; ///< The gamepad mapping was updated

    constexpr EventType EVENT_GAMEPAD_TOUCHPAD_DOWN = SDL_EVENT_GAMEPAD_TOUCHPAD_DOWN; ///< Gamepad touchpad was touched
    ...
    constexpr EventType EVENT_GAMEPAD_SENSOR_UPDATE = SDL_EVENT_GAMEPAD_SENSOR_UPDATE; ///< Gamepad sensor was updated
    ...
    constexpr EventType EVENT_FINGER_MOTION = SDL_EVENT_FINGER_MOTION; ///< FINGER_MOTION

    constexpr EventType EVENT_FINGER_CANCELED = SDL_EVENT_FINGER_CANCELED; ///< FINGER_CANCELED

#if SDL_VERSION_ATLEAST(3, 4, 0)

    constexpr EventType EVENT_PINCH_BEGIN = SDL_EVENT_PINCH_BEGIN; ///< Pinch gesture started

    constexpr EventType EVENT_PINCH_UPDATE = SDL_EVENT_PINCH_UPDATE; ///< Pinch gesture updated

    constexpr EventType EVENT_PINCH_END = SDL_EVENT_PINCH_END; ///< Pinch gesture ended

#endif // SDL_VERSION_ATLEAST(3, 4, 0)

    constexpr EventType EVENT_CLIPBOARD_UPDATE = SDL_EVENT_CLIPBOARD_UPDATE; ///< The clipboard changed

    constexpr EventType EVENT_DROP_FILE = SDL_EVENT_DROP_FILE; ///< The system requests a file open

    constexpr EventType EVENT_DROP_TEXT = SDL_EVENT_DROP_TEXT; ///< text/plain drag-and-drop event

    constexpr EventType EVENT_DROP_BEGIN = SDL_EVENT_DROP_BEGIN; ///< A new set of drops is beginning (NULL filename)

    /// Current set of drops is now complete (NULL filename)
    constexpr EventType EVENT_DROP_COMPLETE = SDL_EVENT_DROP_COMPLETE;

    constexpr EventType EVENT_DROP_POSITION = SDL_EVENT_DROP_POSITION; ///< Position while moving over the window

    constexpr EventType EVENT_AUDIO_DEVICE_ADDED = SDL_EVENT_AUDIO_DEVICE_ADDED; ///< A new audio device is available

    constexpr EventType EVENT_AUDIO_DEVICE_REMOVED =
        SDL_EVENT_AUDIO_DEVICE_REMOVED; ///< An audio device has been removed.

    /// An audio device's format has been changed by the system.
    constexpr EventType EVENT_AUDIO_DEVICE_FORMAT_CHANGED = SDL_EVENT_AUDIO_DEVICE_FORMAT_CHANGED;

    constexpr EventType EVENT_SENSOR_UPDATE = SDL_EVENT_SENSOR_UPDATE; ///< A sensor was updated
    ...
    constexpr EventType EVENT_PEN_DOWN = SDL_EVENT_PEN_DOWN; ///< Pressure-sensitive pen touched drawing surface

    /// Pressure-sensitive pen stopped touching drawing surface
    constexpr EventType EVENT_PEN_UP = SDL_EVENT_PEN_UP;

    constexpr EventType EVENT_PEN_BUTTON_DOWN = SDL_EVENT_PEN_BUTTON_DOWN; ///< Pressure-sensitive pen button pressed

    constexpr EventType EVENT_PEN_BUTTON_UP = SDL_EVENT_PEN_BUTTON_UP; ///< Pressure-sensitive pen button released

    constexpr EventType EVENT_PEN_MOTION = SDL_EVENT_PEN_MOTION; ///< Pressure-sensitive pen is moving on the tablet

    constexpr EventType EVENT_PEN_AXIS = SDL_EVENT_PEN_AXIS; ///< Pressure-sensitive pen angle/pressure/etc changed

    constexpr EventType EVENT_CAMERA_DEVICE_ADDED = SDL_EVENT_CAMERA_DEVICE_ADDED; ///< A new camera device is available

    constexpr EventType EVENT_CAMERA_DEVICE_REMOVED =
        SDL_EVENT_CAMERA_DEVICE_REMOVED; ///< A camera device has been removed.

    /// A camera device has been approved for use by the user.
    constexpr EventType EVENT_CAMERA_DEVICE_APPROVED = SDL_EVENT_CAMERA_DEVICE_APPROVED;
    ...
    constexpr EventType EVENT_POLL_SENTINEL = SDL_EVENT_POLL_SENTINEL; ///< Signals the end of an event poll cycle
    ...
    constexpr EventType EVENT_ENUM_PADDING = SDL_EVENT_ENUM_PADDING; ///< ENUM_PADDING
    ...
    constexpr EventAction ADDEVENT = SDL_ADDEVENT; ///< Add events to the back of the queue.
     ...
     * @sa FlushEvent
     */
    inline void FlushEvents(Uint32 minType = EVENT_FIRST, Uint32 maxType = EVENT_LAST)
    {
    ...
    {
        CheckError(SDL_WaitEvent(event));
    }
     ...
     * @sa WaitEvent
     */
    inline std::optional<Event> WaitEventTimeout(std::chrono::milliseconds timeoutDuration)
    {
        static_assert(false, "Not implemented");
    }
    ...
    {
        CheckError(SDL_PushEvent(event));
    }
     ...
     * @sa SetEventEnabled
     */
    inline bool EventEnabled(Uint32 type)
    {
     ...
     *
     * ```
     * EVENT_MOUSE_MOTION (timestamp=1140256324 windowid=2 which=0 state=0 x=492.99 y=139.09 xrel=52 yrel=6)
     * ```
     *
