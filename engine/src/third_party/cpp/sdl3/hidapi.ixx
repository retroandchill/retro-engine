...
namespace SDL
{
    ...
    constexpr hid_bus_type HID_API_BUS_UNKNOWN = SDL_HID_API_BUS_UNKNOWN; ///< Unknown bus type

    constexpr hid_bus_type HID_API_BUS_USB = SDL_HID_API_BUS_USB; ///< USB bus Specifications: https://usb.org/hid
    ...
    struct HidDeviceBase : ResourceBaseT<HidDeviceRaw>
    {
         ...
         *          valid until the device is closed with hid_close().
         *
         * @since This function is available since SDL 3.2.0.
         */
    ...
    struct HidDevice : HidDeviceBase
    {
         ...
         */
        constexpr explicit HidDevice(HidDeviceRaw resource) noexcept : HidDeviceBase(resource)
        {
        }

        /// Move constructor
        constexpr HidDevice(HidDevice &&other) noexcept : HidDevice(other.release())
        {
        }
     ...
     * @sa hid_exit
     */
    inline void hid_init()
    {
        CheckErrorIfNot(SDL_hid_init(), 0);
    }
    ...
    {
        CheckErrorIfNot(SDL_hid_exit(), 0);
    }
     ...
     */
    inline hid_device_info *hid_enumerate(unsigned short vendor_id, unsigned short product_id)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline HidDevice hid_open(unsigned short vendor_id, unsigned short product_id, const wchar_t *serial_number)
    {
        return HidDevice(vendor_id, product_id, serial_number);
    }

    inline HidDevice::HidDevice(unsigned short vendor_id, unsigned short product_id, const wchar_t *serial_number)
        : HidDevice(CheckError(SDL_hid_open(vendor_id, product_id, serial_number)))
    {
    }

    inline HidDevice::HidDevice(StringParam path) : HidDevice(CheckError(SDL_hid_open_path(path)))
    {
    }
    ...
    namespace prop::Hidapi
    {
        ...
        constexpr auto LIBUSB_DEVICE_HANDLE_POINTER =
            SDL_PROP_HIDAPI_LIBUSB_DEVICE_HANDLE_POINTER; ///< Pointer to libusb device handle.
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline int hid_read_timeout(HidDeviceRef dev, TargetBytes data, Milliseconds timeout)
    {
    ...
    inline void HidDeviceBase::close()
    {
        hid_close(release());
    }
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void hid_get_manufacturer_string(HidDeviceRef dev, wchar_t *string, size_t maxlen)
    {
        CheckErrorIfNot(SDL_hid_get_manufacturer_string(dev, string, maxlen), 0);
    }

    inline void HidDeviceBase::get_manufacturer_string(wchar_t *string, size_t maxlen)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void hid_get_product_string(HidDeviceRef dev, wchar_t *string, size_t maxlen)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void hid_get_serial_number_string(HidDeviceRef dev, wchar_t *string, size_t maxlen)
    {
        CheckErrorIfNot(SDL_hid_get_serial_number_string(dev, string, maxlen), 0);
    }

    inline void HidDeviceBase::get_serial_number_string(wchar_t *string, size_t maxlen)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void hid_get_indexed_string(HidDeviceRef dev, int string_index, wchar_t *string, size_t maxlen)
    {
        CheckErrorIfNot(SDL_hid_get_indexed_string(dev, string_index, string, maxlen), 0);
    }

    inline void HidDeviceBase::get_indexed_string(int string_index, wchar_t *string, size_t maxlen)
    {
     ...
     *          until the device is closed with hid_close().
     *
     * @since This function is available since SDL 3.2.0.
     */
