...
namespace SDL
{
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void CPUPauseInstruction()
    {
    ...
    {
        constexpr AtomicInt(int value) : AtomicIntRaw(value)
        {
        }
    ...
    inline int AtomicInt::Set(int v)
    {
        return SDL::SetAtomicInt(this, v);
    }
     ...
     * @sa SetAtomicInt
     */
    inline int GetAtomicInt(AtomicIntRaw *a)
    {
    ...
    {
        return SDL::AddAtomicInt(this, v);
    }
     ...
     * @sa AtomicDecRef
     */
    inline bool AtomicIncRef(AtomicIntRaw *a)
    {
        return SDL_AtomicIncRef(a);
    }

    inline bool AtomicInt::AtomicIncRef()
    {
        return SDL::AtomicIncRef(this);
    }
     ...
     * @sa AtomicIncRef
     */
    inline bool AtomicDecRef(AtomicIntRaw *a)
    {
        return SDL_AtomicDecRef(a);
    }

    inline bool AtomicInt::AtomicDecRef()
    {
        return SDL::AtomicDecRef(this);
    }
    ...
    {
      public:
        constexpr AtomicU32(Uint32 value) : m_value(value)
        {
        }
    ...
    class AtomicPointer
    {
      ...
      public:
        constexpr AtomicPointer(T *value) : m_value(value)
        {
        }
     ...
     * @sa SetAtomicU32
     */
    inline bool CompareAndSwapAtomicU32(AtomicU32Raw *a, Uint32 oldval, Uint32 newval)
    {
    ...
    {
        return SDL::SetAtomicU32(this, v);
    }
     ...
     * @sa SetAtomicU32
     */
    inline Uint32 GetAtomicU32(AtomicU32Raw *a)
    {
        return SDL_GetAtomicU32(a);
    }

    inline Uint32 AtomicU32::Get()
    {
        return SDL::GetAtomicU32(this);
    }
    ...
    inline Uint32 AtomicU32::Add(int v)
    {
        return SDL::AddAtomicU32(this, v);
    }
