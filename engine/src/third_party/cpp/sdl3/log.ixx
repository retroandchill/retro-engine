...
namespace SDL
{
    ...
    constexpr LogPriority LOG_PRIORITY_INVALID = SDL_LOG_PRIORITY_INVALID; ///< INVALID

    constexpr LogPriority LOG_PRIORITY_TRACE = SDL_LOG_PRIORITY_TRACE; ///< TRACE

    constexpr LogPriority LOG_PRIORITY_VERBOSE = SDL_LOG_PRIORITY_VERBOSE; ///< VERBOSE
    ...
    constexpr LogPriority LOG_PRIORITY_CRITICAL = SDL_LOG_PRIORITY_CRITICAL; ///< CRITICAL
    ...
    class LogCategory
    {
      ...
      public:
         ...
         */
        constexpr LogCategory(LogCategoryRaw category = {}) noexcept : m_category(category)
        {
        }
         ...
         */
        constexpr operator LogCategoryRaw() const noexcept
        {
            return m_category;
        }
    ...
    constexpr LogCategory LOG_CATEGORY_APPLICATION = SDL_LOG_CATEGORY_APPLICATION; ///< APPLICATION
    ...
    constexpr LogCategory LOG_CATEGORY_RESERVED2 = SDL_LOG_CATEGORY_RESERVED2; ///< RESERVED2

    constexpr LogCategory LOG_CATEGORY_RESERVED3 = SDL_LOG_CATEGORY_RESERVED3; ///< RESERVED3

    constexpr LogCategory LOG_CATEGORY_RESERVED4 = SDL_LOG_CATEGORY_RESERVED4; ///< RESERVED4

    constexpr LogCategory LOG_CATEGORY_RESERVED5 = SDL_LOG_CATEGORY_RESERVED5; ///< RESERVED5

    constexpr LogCategory LOG_CATEGORY_RESERVED6 = SDL_LOG_CATEGORY_RESERVED6; ///< RESERVED6

    constexpr LogCategory LOG_CATEGORY_RESERVED7 = SDL_LOG_CATEGORY_RESERVED7; ///< RESERVED7

    constexpr LogCategory LOG_CATEGORY_RESERVED8 = SDL_LOG_CATEGORY_RESERVED8; ///< RESERVED8

    constexpr LogCategory LOG_CATEGORY_RESERVED9 = SDL_LOG_CATEGORY_RESERVED9; ///< RESERVED9

    constexpr LogCategory LOG_CATEGORY_RESERVED10 = SDL_LOG_CATEGORY_RESERVED10; ///< RESERVED10
     ...
     */
    template <class... ARGS>
    inline void LogVerbose(LogCategory category, std::string_view fmt, ARGS &&...args)
    {
     ...
     */
    template <class... ARGS>
    inline void LogCritical(LogCategory category, std::string_view fmt, ARGS &&...args)
    {
     ...
     */
    template <class... ARGS>
    inline void LogMessage(LogCategory category, LogPriority priority, std::string_view fmt, ARGS... args)
    {
        SDL_LogMessage(category, priority, fmt, args);
    }

    template <class... ARGS>
    inline void LogCategory::LogMessage(LogPriority priority, std::string_view fmt, ARGS... args) const
    {
     ...
     */
    using LogOutputFunction = void(SDLCALL *)(void *userdata, int category, LogPriority priority, const char *message);
     ...
     */
    using LogOutputCB = MakeFrontCallback<void(int category, LogPriority priority, const char *message)>;
