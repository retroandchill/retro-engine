...
namespace SDL
{
    ...
    class Scancode
    {
      ...
      public:
         ...
         */
        constexpr Scancode(ScancodeRaw scancode = {}) noexcept : m_scancode(scancode)
        {
        }
         ...
         */
        constexpr operator ScancodeRaw() const noexcept
        {
            return m_scancode;
        }
    ...
    constexpr Scancode SCANCODE_LEFTBRACKET = SDL_SCANCODE_LEFTBRACKET; ///< LEFTBRACKET

    constexpr Scancode SCANCODE_RIGHTBRACKET = SDL_SCANCODE_RIGHTBRACKET; ///< RIGHTBRACKET
    ...
    constexpr Scancode SCANCODE_APOSTROPHE = SDL_SCANCODE_APOSTROPHE; ///< APOSTROPHE
    ...
    constexpr Scancode SCANCODE_PRINTSCREEN = SDL_SCANCODE_PRINTSCREEN; ///< PRINTSCREEN

    constexpr Scancode SCANCODE_SCROLLLOCK = SDL_SCANCODE_SCROLLLOCK; ///< SCROLLLOCK
    ...
    constexpr Scancode SCANCODE_NUMLOCKCLEAR = SDL_SCANCODE_NUMLOCKCLEAR; ///< num lock on PC, clear on Mac keyboards

    constexpr Scancode SCANCODE_KP_DIVIDE = SDL_SCANCODE_KP_DIVIDE; ///< KP_DIVIDE

    constexpr Scancode SCANCODE_KP_MULTIPLY = SDL_SCANCODE_KP_MULTIPLY; ///< KP_MULTIPLY
    ...
    constexpr Scancode SCANCODE_APPLICATION = SDL_SCANCODE_APPLICATION; ///< windows contextual menu, compose
    ...
    constexpr Scancode SCANCODE_VOLUMEDOWN = SDL_SCANCODE_VOLUMEDOWN; ///< VOLUMEDOWN

    constexpr Scancode SCANCODE_KP_COMMA = SDL_SCANCODE_KP_COMMA; ///< KP_COMMA

    constexpr Scancode SCANCODE_KP_EQUALSAS400 = SDL_SCANCODE_KP_EQUALSAS400; ///< KP_EQUALSAS400

    constexpr Scancode SCANCODE_INTERNATIONAL1 =
        SDL_SCANCODE_INTERNATIONAL1; ///< used on Asian keyboards, see footnotes in USB doc

    constexpr Scancode SCANCODE_INTERNATIONAL2 = SDL_SCANCODE_INTERNATIONAL2; ///< INTERNATIONAL2

    constexpr Scancode SCANCODE_INTERNATIONAL3 = SDL_SCANCODE_INTERNATIONAL3; ///< Yen

    constexpr Scancode SCANCODE_INTERNATIONAL4 = SDL_SCANCODE_INTERNATIONAL4; ///< INTERNATIONAL4

    constexpr Scancode SCANCODE_INTERNATIONAL5 = SDL_SCANCODE_INTERNATIONAL5; ///< INTERNATIONAL5

    constexpr Scancode SCANCODE_INTERNATIONAL6 = SDL_SCANCODE_INTERNATIONAL6; ///< INTERNATIONAL6

    constexpr Scancode SCANCODE_INTERNATIONAL7 = SDL_SCANCODE_INTERNATIONAL7; ///< INTERNATIONAL7

    constexpr Scancode SCANCODE_INTERNATIONAL8 = SDL_SCANCODE_INTERNATIONAL8; ///< INTERNATIONAL8

    constexpr Scancode SCANCODE_INTERNATIONAL9 = SDL_SCANCODE_INTERNATIONAL9; ///< INTERNATIONAL9
    ...
    constexpr Scancode SCANCODE_CLEARAGAIN = SDL_SCANCODE_CLEARAGAIN; ///< CLEARAGAIN
    ...
    constexpr Scancode SCANCODE_THOUSANDSSEPARATOR = SDL_SCANCODE_THOUSANDSSEPARATOR; ///< THOUSANDSSEPARATOR

    constexpr Scancode SCANCODE_DECIMALSEPARATOR = SDL_SCANCODE_DECIMALSEPARATOR; ///< DECIMALSEPARATOR

    constexpr Scancode SCANCODE_CURRENCYUNIT = SDL_SCANCODE_CURRENCYUNIT; ///< CURRENCYUNIT

    constexpr Scancode SCANCODE_CURRENCYSUBUNIT = SDL_SCANCODE_CURRENCYSUBUNIT; ///< CURRENCYSUBUNIT

    constexpr Scancode SCANCODE_KP_LEFTPAREN = SDL_SCANCODE_KP_LEFTPAREN; ///< KP_LEFTPAREN

    constexpr Scancode SCANCODE_KP_RIGHTPAREN = SDL_SCANCODE_KP_RIGHTPAREN; ///< KP_RIGHTPAREN

    constexpr Scancode SCANCODE_KP_LEFTBRACE = SDL_SCANCODE_KP_LEFTBRACE; ///< KP_LEFTBRACE

    constexpr Scancode SCANCODE_KP_RIGHTBRACE = SDL_SCANCODE_KP_RIGHTBRACE; ///< KP_RIGHTBRACE

    constexpr Scancode SCANCODE_KP_TAB = SDL_SCANCODE_KP_TAB; ///< KP_TAB

    constexpr Scancode SCANCODE_KP_BACKSPACE = SDL_SCANCODE_KP_BACKSPACE; ///< KP_BACKSPACE
    ...
    constexpr Scancode SCANCODE_KP_PERCENT = SDL_SCANCODE_KP_PERCENT; ///< KP_PERCENT

    constexpr Scancode SCANCODE_KP_LESS = SDL_SCANCODE_KP_LESS; ///< KP_LESS

    constexpr Scancode SCANCODE_KP_GREATER = SDL_SCANCODE_KP_GREATER; ///< KP_GREATER

    constexpr Scancode SCANCODE_KP_AMPERSAND = SDL_SCANCODE_KP_AMPERSAND; ///< KP_AMPERSAND

    constexpr Scancode SCANCODE_KP_DBLAMPERSAND = SDL_SCANCODE_KP_DBLAMPERSAND; ///< KP_DBLAMPERSAND

    constexpr Scancode SCANCODE_KP_VERTICALBAR = SDL_SCANCODE_KP_VERTICALBAR; ///< KP_VERTICALBAR

    constexpr Scancode SCANCODE_KP_DBLVERTICALBAR = SDL_SCANCODE_KP_DBLVERTICALBAR; ///< KP_DBLVERTICALBAR
    ...
    constexpr Scancode SCANCODE_KP_MEMSTORE = SDL_SCANCODE_KP_MEMSTORE; ///< KP_MEMSTORE

    constexpr Scancode SCANCODE_KP_MEMRECALL = SDL_SCANCODE_KP_MEMRECALL; ///< KP_MEMRECALL

    constexpr Scancode SCANCODE_KP_MEMCLEAR = SDL_SCANCODE_KP_MEMCLEAR; ///< KP_MEMCLEAR

    constexpr Scancode SCANCODE_KP_MEMADD = SDL_SCANCODE_KP_MEMADD; ///< KP_MEMADD

    constexpr Scancode SCANCODE_KP_MEMSUBTRACT = SDL_SCANCODE_KP_MEMSUBTRACT; ///< KP_MEMSUBTRACT

    constexpr Scancode SCANCODE_KP_MEMMULTIPLY = SDL_SCANCODE_KP_MEMMULTIPLY; ///< KP_MEMMULTIPLY

    constexpr Scancode SCANCODE_KP_MEMDIVIDE = SDL_SCANCODE_KP_MEMDIVIDE; ///< KP_MEMDIVIDE

    constexpr Scancode SCANCODE_KP_PLUSMINUS = SDL_SCANCODE_KP_PLUSMINUS; ///< KP_PLUSMINUS

    constexpr Scancode SCANCODE_KP_CLEAR = SDL_SCANCODE_KP_CLEAR; ///< KP_CLEAR

    constexpr Scancode SCANCODE_KP_CLEARENTRY = SDL_SCANCODE_KP_CLEARENTRY; ///< KP_CLEARENTRY
    ...
    constexpr Scancode SCANCODE_KP_DECIMAL = SDL_SCANCODE_KP_DECIMAL; ///< KP_DECIMAL

    constexpr Scancode SCANCODE_KP_HEXADECIMAL = SDL_SCANCODE_KP_HEXADECIMAL; ///< KP_HEXADECIMAL
    ...
    constexpr Scancode SCANCODE_LGUI = SDL_SCANCODE_LGUI; ///< windows, command (apple), meta
    ...
    constexpr Scancode SCANCODE_RGUI = SDL_SCANCODE_RGUI; ///< windows, command (apple), meta
    ...
    constexpr Scancode SCANCODE_CHANNEL_INCREMENT = SDL_SCANCODE_CHANNEL_INCREMENT; ///< Channel Increment

    constexpr Scancode SCANCODE_CHANNEL_DECREMENT = SDL_SCANCODE_CHANNEL_DECREMENT; ///< Channel Decrement
    ...
    constexpr Scancode SCANCODE_MEDIA_FAST_FORWARD = SDL_SCANCODE_MEDIA_FAST_FORWARD; ///< Fast Forward

    constexpr Scancode SCANCODE_MEDIA_REWIND = SDL_SCANCODE_MEDIA_REWIND; ///< Rewind

    constexpr Scancode SCANCODE_MEDIA_NEXT_TRACK = SDL_SCANCODE_MEDIA_NEXT_TRACK; ///< Next Track

    constexpr Scancode SCANCODE_MEDIA_PREVIOUS_TRACK = SDL_SCANCODE_MEDIA_PREVIOUS_TRACK; ///< Previous Track
    ...
    constexpr Scancode SCANCODE_MEDIA_PLAY_PAUSE = SDL_SCANCODE_MEDIA_PLAY_PAUSE; ///< Play / Pause

    constexpr Scancode SCANCODE_MEDIA_SELECT = SDL_SCANCODE_MEDIA_SELECT; ///< MEDIA_SELECT
    ...
    constexpr Scancode SCANCODE_AC_PROPERTIES = SDL_SCANCODE_AC_PROPERTIES; ///< AC Properties
    ...
    constexpr Scancode SCANCODE_AC_BOOKMARKS = SDL_SCANCODE_AC_BOOKMARKS; ///< AC Bookmarks
    ...
    constexpr Scancode SCANCODE_CALL = SDL_SCANCODE_CALL; ///< Used for accepting phone calls.

    constexpr Scancode SCANCODE_ENDCALL = SDL_SCANCODE_ENDCALL; ///< Used for rejecting phone calls.

    constexpr Scancode SCANCODE_RESERVED = SDL_SCANCODE_RESERVED; ///< 400-500 reserved for dynamic keycodes
