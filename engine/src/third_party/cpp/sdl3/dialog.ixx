...
namespace SDL
{
     ...
     * @sa ShowFileDialogWithProperties
     */
    using DialogFileCallback = void(SDLCALL *)(void *userdata, const char *const *filelist, int filter);
     ...
     * @sa DialogFileCallback
     */
    using DialogFileCB = std::function<void(const char *const *filelist, int filter)>;
    ...
    inline void ShowOpenFileDialog(DialogFileCallback callback,
                                   ...
                                   bool allow_many)
    {
        SDL_ShowOpenFileDialog(callback, userdata, window, filters, default_location, allow_many);
    }
    ...
    constexpr FileDialogType FILEDIALOG_OPENFILE = SDL_FILEDIALOG_OPENFILE; ///< OPENFILE

    constexpr FileDialogType FILEDIALOG_SAVEFILE = SDL_FILEDIALOG_SAVEFILE; ///< SAVEFILE

    constexpr FileDialogType FILEDIALOG_OPENFOLDER = SDL_FILEDIALOG_OPENFOLDER; ///< OPENFOLDER
     ...
     * @sa ShowOpenFolderDialog
     */
    inline void ShowFileDialogWithProperties(FileDialogType type, DialogFileCB callback, PropertiesID props)
    {
        static_assert(false, "Not implemented");
    }
    ...
    namespace prop::FileDialog
    {
        ...
        constexpr auto FILTERS_POINTER = SDL_PROP_FILE_DIALOG_FILTERS_POINTER; ///< Pointer to filters.

        constexpr auto NFILTERS_NUMBER = SDL_PROP_FILE_DIALOG_NFILTERS_NUMBER; ///< Number of filters.

        constexpr auto WINDOW_POINTER = SDL_PROP_FILE_DIALOG_WINDOW_POINTER; ///< Pointer to window.

        constexpr auto LOCATION_STRING = SDL_PROP_FILE_DIALOG_LOCATION_STRING; ///< String for location.

        constexpr auto MANY_BOOLEAN = SDL_PROP_FILE_DIALOG_MANY_BOOLEAN; ///< Many enabled.

        constexpr auto TITLE_STRING = SDL_PROP_FILE_DIALOG_TITLE_STRING; ///< String for title.

        constexpr auto ACCEPT_STRING = SDL_PROP_FILE_DIALOG_ACCEPT_STRING; ///< String for accept.

        constexpr auto CANCEL_STRING = SDL_PROP_FILE_DIALOG_CANCEL_STRING; ///< String for cancel.
