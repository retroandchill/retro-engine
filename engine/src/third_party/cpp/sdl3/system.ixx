...
namespace SDL
{
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void GetDXGIOutputInfo(Display displayID, int *adapterIndex, int *outputIndex)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SetLinuxThreadPriorityAndPolicy(Sint64 threadID, int sdlPriority, int schedPolicy)
    {
        CheckError(SDL_SetLinuxThreadPriorityAndPolicy(threadID, sdlPriority, schedPolicy));
    }
    ...
    inline void SetiOSAnimationCallback(WindowRef window,
                                        ...
                                        void *callbackParam)
    {
        CheckError(SDL_SetiOSAnimationCallback(window, interval, callback, callbackParam));
    }
     ...
     * @sa SetiOSAnimationCallback
     */
    inline void SetiOSEventPump(bool enabled)
    {
    ...
    {
        return CheckError(SDL_GetAndroidJNIEnv());
    }
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void SendAndroidBackButton()
    {
     ...
     */
    constexpr Uint32 ANDROID_EXTERNAL_STORAGE_READ = SDL_ANDROID_EXTERNAL_STORAGE_READ;
     ...
     * @since This constant is available since SDL 3.2.0.
     */
    constexpr Uint32 ANDROID_EXTERNAL_STORAGE_WRITE = SDL_ANDROID_EXTERNAL_STORAGE_WRITE;
     ...
     */
    using RequestAndroidPermissionCallback = void(SDLCALL *)(void *userdata, const char *permission, bool granted);
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline bool RequestAndroidPermission(StringParam permission, RequestAndroidPermissionCallback cb, void *userdata)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline bool RequestAndroidPermission(StringParam permission, RequestAndroidPermissionCB cb)
    {
     ...
     * @since This function is available since SDL 3.2.0.
     */
    inline void ShowAndroidToast(StringParam message, int duration, int gravity, int xoffset, int yoffset)
    {
        CheckError(SDL_ShowAndroidToast(message, duration, gravity, xoffset, yoffset));
    }
    ...
    constexpr Sandbox SANDBOX_UNKNOWN_CONTAINER = SDL_SANDBOX_UNKNOWN_CONTAINER; ///< UNKNOWN_CONTAINER
     ...
     * all this for windows created by CreateWindow!
     *
     * @threadsafety It is safe to call this function from any thread.
     *
     * @since This function is available since SDL 3.2.0.
