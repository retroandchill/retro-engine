...
namespace RetroEngine.Utilities.SourceGenerator.Common.Extensions;

public static class CodeWritingUtils
{
    public static void WriteSuppressWarning(
    ...
    public static void WriteContainingBlocks(
        TypeInfo typeInfo,
