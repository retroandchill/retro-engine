...
using CodeGenerating_TypeDefinition = RetroEngine.Utilities.SourceGenerator.Common.CodeGenerating.TypeDefinition;
using TypeName = RetroEngine.Utilities.SourceGenerator.Common.CodeAnalyzing.TypeName;

namespace RetroEngine.Utilities.SourceGenerator.Constructors;

[Generator]
public class InheritConstructorSourceGenerator : IIncrementalGenerator
{
    private readonly Dictionary<ITypeSymbol, CodeAnalyzing_TypeInfo> _typesCache = new(SymbolEqualityComparer.Default);
    ...
    private CodeGenerating_TypeDefinition CreateTypeDefinition(INamedTypeSymbol typeSymbol)
    {
        return new CodeGenerating_TypeDefinition
        {
            IsPartial = true,
            Name = typeSymbol.Name,
            Kind = Common.CodeGenerating.TypeKind.Class(false, false),
    ...
    private CodeAnalyzing_TypeInfo GetOrCreateTypeDefinition(ITypeSymbol typeSymbol)
    {
