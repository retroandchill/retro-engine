    ...
    : IUnionCodeGenerator
{
    ...
    )
    {
        private static readonly TypeName StateName = new(
            Common.CodeAnalyzing.TypeInfo.SpecialName("TState", Common.CodeAnalyzing.TypeInfo.TypeKind.Unknown()),
            false
        );

        private static readonly TypeName RetName = new(
            Common.CodeAnalyzing.TypeInfo.SpecialName("TRet", Common.CodeAnalyzing.TypeInfo.TypeKind.Unknown()),
            false
        );
