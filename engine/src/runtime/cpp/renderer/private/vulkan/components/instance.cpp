...
namespace retro
{
    ...
    VulkanInstance::VulkanInstance(const WindowBackend backend)
    {
...
#ifndef NDEBUG
        const vk::DebugUtilsMessengerCreateInfoEXT messenger_ci{
        ...
        dldi_ = std::make_unique<vk::detail::DispatchLoaderDynamic>(
            instance_.get(),
