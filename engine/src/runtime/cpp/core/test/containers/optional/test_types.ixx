...
export namespace retro::tests
{
    ...
    struct move_detector
    {
        ...
        constexpr move_detector(move_detector &&rhs)
        {
            rhs.been_moved = true;
        }
    ...
    {
        explicit operator copyable_from_non_const_lvalue_only() &
        {
            return copyable_from_non_const_lvalue_only{};
        }
    ...
    struct explicitly_convertible_from_const_lvalue_only
    {
        ...
        explicit operator copyable_from_const_lvalue_only() const &
        {
            return copyable_from_const_lvalue_only{};
        }
        explicit operator copyable_from_const_lvalue_only() && = delete;
