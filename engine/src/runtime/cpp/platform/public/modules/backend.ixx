...
namespace retro
{
    ...
    export class PlatformBackend
    {
      public:
        ...
        virtual PlatformResult<std::unique_ptr<Window>> create_window(const WindowDesc &desc) = 0;

        virtual Task<PlatformResult<std::unique_ptr<Window>>> create_window_async(WindowDesc desc) = 0;
