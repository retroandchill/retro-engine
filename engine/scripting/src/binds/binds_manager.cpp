...
namespace retro {
    ...
    // NOLINTNEXTLINE
    void * BindsManager::get_bound_function(const char16_t *module_name, const int32 module_length,
                                          const char16_t *function_name, const int32 function_length, int32 param_size) {
        ...
        for (auto &instance = BindsManager::instance(); const auto &exported_function : instance.exported_functions_[name]) {
