...
TEST(OptionalTest, Constructors)
{
    ...
    retro::Optional<int> e2{std::nullopt};
...
TEST(OptionalTest, Constructors2)
{
    ...
    retro::Optional<int> o3 = 42;
    EXPECT_TRUE(*o3 == 42);

    retro::Optional<int> o4 = o3;
    EXPECT_TRUE(*o4 == 42);

    retro::Optional<int> o5 = o1;
    EXPECT_TRUE(!o5);

    retro::Optional<int> o6 = std::move(o3);
    EXPECT_TRUE(*o6 == 42);

    retro::Optional<short> o7 = 42;
    EXPECT_TRUE(*o7 == 42);

    retro::Optional<int> o8 = o7;
    EXPECT_TRUE(*o8 == 42);

    retro::Optional<int> o9 = std::move(o7);
    EXPECT_TRUE(*o9 == 42);

    {
        ...
        retro::Optional<int &> oo = o;
        EXPECT_TRUE(!oo);
    }

    {
        auto i = 42;
        retro::Optional<int &> o = i;
        EXPECT_TRUE(o);
        EXPECT_TRUE(*o == 42);
    ...
    std::vector<base> v;
    v.emplace_back();
    retro::Optional<std::vector<base>> ov = std::move(v);
...
{
    using retro::tests::int_ctor;

    int_ctor i = 7;
    retro::Optional<int_ctor> v1{};
    retro::Optional<int_ctor> v2{i};
    std::ignore = v1;
    std::ignore = v2;
}
...
TEST(OptionalTest, OptionalOfOptional)
{
    ...
    retro::Optional<O> oo2 = std::move(o);
    ...
    oo2.emplace(std::nullopt);
    EXPECT_TRUE(oo2.has_value());
    EXPECT_FALSE(oo2->has_value());
    oo2.emplace(std::in_place, 41);
    EXPECT_TRUE(oo2.has_value());
...
TEST(OptionalTest, EmplaceVariadic)
{
    ...
    retro::Optional<for_emplace> o3;
    o3.emplace(1, 2, 3);
    EXPECT_TRUE(o3.has_value());

    retro::Optional<for_emplace> engaged{f};
...
TEST(OptionalTest, AssignmentValue)
{
    ...
    */
    ...
    retro::Optional<not_trivial_copy_assignable> o7{7};
    o6 = o7;
    EXPECT_TRUE(o6);
    EXPECT_TRUE(o6->i_ == 7);

    // Move into engaged optional.
    retro::Optional<not_trivial_copy_assignable> o8{8};
    o6 = std::move(o8);
    EXPECT_TRUE(o6);
    EXPECT_TRUE(o6->i_ == 8);
...
TEST(OptionalTest, ConvertingValueAssignment)
{
    ...
    retro::Optional<base> empty;
    retro::Optional<base> engaged(base{});
    ...
    EXPECT_THROW(
        {
            ...
            {
                EXPECT_STREQ("Bad optional access", e.what());
                throw;
            }
        },
        std::bad_optional_access);

    EXPECT_THROW({ std::as_const(empty).value(); }, std::bad_optional_access);
    EXPECT_THROW({ std::move(empty).value(); }, std::bad_optional_access);
}
...
{
    retro::Optional<int> o1{std::in_place};
    retro::Optional<int> o2(std::in_place);
    EXPECT_TRUE(o1);
    EXPECT_TRUE(o1 == 0);
    EXPECT_TRUE(o2);
    EXPECT_TRUE(o2 == 0);

    retro::Optional<int> o3(std::in_place, 42);
    EXPECT_TRUE(o3 == 42);

    retro::Optional<std::tuple<int, int>> o4(std::in_place, 0, 1);
    EXPECT_TRUE(o4);
    ...
    retro::Optional<takes_init_and_variadic> o6(std::in_place, {0, 1}, 2, 3);
...
{
    auto o1 = retro::make_optional(42);
    auto o2 = retro::Optional<int>(42);

    constexpr bool is_same = std::is_same<decltype(o1), retro::Optional<int>>::value;
    EXPECT_TRUE(is_same);
    EXPECT_TRUE(o1 == o2);

    auto o3 = retro::make_optional<std::tuple<int, int, int, int>>(0, 1, 2, 3);
    EXPECT_TRUE(std::get<0>(*o3) == 0);
    EXPECT_TRUE(std::get<1>(*o3) == 1);
    EXPECT_TRUE(std::get<2>(*o3) == 2);
    EXPECT_TRUE(std::get<3>(*o3) == 3);

    auto o4 = retro::make_optional<std::vector<int>>({0, 1, 2, 3});
    EXPECT_TRUE(o4.value()[0] == 0);
    EXPECT_TRUE(o4.value()[1] == 1);
    EXPECT_TRUE(o4.value()[2] == 2);
    EXPECT_TRUE(o4.value()[3] == 3);

    auto o5 = retro::make_optional<takes_init_and_variadic>({0, 1}, 2, 3);
    ...
    auto o6 = retro::make_optional<for_variadic>(0, 1, 3);
    EXPECT_TRUE(o6);
    EXPECT_EQ(o6->a, 0);
}
...
TEST(OptionalTest, Observers)
{
    retro::Optional<int> o1 = 42;
    retro::Optional<int> o2;
    const retro::Optional<int> o3 = 42;
    ...
    retro::Optional<move_detector> o4{std::in_place};
...
TEST(OptionalTest, RelationalOps)
{
    ...
    retro::Optional<std::string> o4{"hello"};
    retro::Optional<std::string> o5{"xyz"};
...
TEST(OptionalTest, RangeConstructors)
{
    ...
    retro::Optional<std::optional<int>> n;
    retro::Optional<std::optional<int>> n2{n};
    retro::Optional<std::optional<int>> n3{std::optional<int>{}};
    std::ignore = n2;
    std::ignore = n3;
}
...
{
    static_assert(std::ranges::range<retro::Optional<int &>>);
    static_assert(std::ranges::view<retro::Optional<int &>>);
    static_assert(std::ranges::input_range<retro::Optional<int &>>);
    static_assert(std::ranges::forward_range<retro::Optional<int &>>);
    static_assert(std::ranges::bidirectional_range<retro::Optional<int &>>);
    static_assert(std::ranges::contiguous_range<retro::Optional<int &>>);
    static_assert(std::ranges::common_range<retro::Optional<int &>>);
    static_assert(std::ranges::viewable_range<retro::Optional<int &>>);
    static_assert(std::ranges::borrowed_range<retro::Optional<int &>>);
    static_assert(std::ranges::random_access_range<retro::Optional<int &>>);
    ...
    static_assert(std::ranges::range<retro::Optional<ref>>);
    static_assert(std::ranges::view<retro::Optional<ref>>);
    static_assert(std::ranges::input_range<retro::Optional<ref>>);
    static_assert(std::ranges::forward_range<retro::Optional<ref>>);
    static_assert(std::ranges::bidirectional_range<retro::Optional<ref>>);
    static_assert(std::ranges::contiguous_range<retro::Optional<ref>>);
    static_assert(std::ranges::common_range<retro::Optional<ref>>);
    static_assert(std::ranges::viewable_range<retro::Optional<ref>>);
    static_assert(std::ranges::borrowed_range<retro::Optional<ref>>);
    static_assert(std::ranges::random_access_range<retro::Optional<ref>>);
}

TEST(OptionalTest, BreathingTest)
{
    retro::Optional<int> m;
    retro::Optional<int> m1{1};
    ...
    retro::Optional<double> d0{0};

    retro::Optional<double> d1{1};
...
TEST(OptionalTest, BreathingTestRef)
{
    ...
    int one = 1;
    retro::Optional<int &> m1{one};

    m = m1;
    ASSERT_EQ(*std::begin(m), 1);

    double zero = 0.0;
    retro::Optional<double &> d0{zero};

    double one_d = 1.0;
    retro::Optional<double &> d1{one_d};
...
{
    retro::Optional<int> m;
    retro::Optional<int> m0{0};
    retro::Optional<int> m1{1};
    retro::Optional<int> m1a{1};
...
TEST(OptionalTest, CompTestRef)
{
    ...
    int one = 1;
    int one_a = 1;
    retro::Optional<int &> m0{zero};
    retro::Optional<int &> m1{one};
    retro::Optional<int &> m1a{one_a};
...
TEST(OptionalTest, PythTripleTest)
{
    ...
    auto triples = and_then(
        iota(1),
        [](int z)
        {
            return and_then(iota(1, z + 1),
                            [=](int x)
                            {
...
{
    int i = 7;
    retro::Optional<int> v1{};

    retro::Optional<int> v2{i};
    for (auto i : v1)
...
TEST(OptionalTest, RefWrapper)
{
    ...
    retro::Optional<int> v2{std::ref(i)};
...
TEST(OptionalTest, RefBase)
{
    ...
    for (auto &&i : retro::Optional<int &>(s))
    {
        ASSERT_EQ(i, 4);
        i = 9;
        ASSERT_EQ(i, 9);
...
TEST(OptionalTest, HashTest)
{
    ...
    retro::Optional<int> o2 = std::nullopt;
    retro::Optional<int> o3 = 42;
    retro::Optional<int> o4 = 42;

    auto h1 = std::hash<retro::Optional<int>>{}(o1);
    auto h2 = std::hash<retro::Optional<int>>{}(o2);
    auto h3 = std::hash<retro::Optional<int>>{}(o3);
    auto h4 = std::hash<retro::Optional<int>>{}(o4);
    ...
    {
        auto h1 = std::hash<retro::Optional<int>>{}(i);
...
{
    using retro::tests::immovable;

    retro::Optional<immovable> o1(std::in_place);
    EXPECT_TRUE(o1);
    ...
    retro::Optional<immovable> o2 = std::nullopt;
    EXPECT_FALSE(o2);
}
...
{
    using retro::tests::copyable_from_non_const_lvalue_only;

    copyable_from_non_const_lvalue_only cm;

    retro::Optional<copyable_from_non_const_lvalue_only &> o1 = cm;
    ASSERT_TRUE(o1);

    {
        retro::Optional<copyable_from_non_const_lvalue_only> o2 = o1;
        ASSERT_TRUE(o2);
    }

    retro::Optional<copyable_from_non_const_lvalue_only> o2 = std::move(o1);
    ASSERT_TRUE(o2);
...
{
    using retro::tests::copyable_from_non_const_lvalue_only;
    using retro::tests::explicitly_convertible_from_non_const_lvalue_only;

    explicitly_convertible_from_non_const_lvalue_only ec;

    retro::Optional<explicitly_convertible_from_non_const_lvalue_only &> o3 = ec;

    retro::Optional<copyable_from_non_const_lvalue_only> o4(o3);
    ASSERT_TRUE(o4);
    retro::Optional<copyable_from_non_const_lvalue_only> o5(std::move(o3));
    ASSERT_TRUE(o5);
}
#endif
...
{
    using retro::tests::copyable_from_const_lvalue_only;

    copyable_from_const_lvalue_only cm;

    retro::Optional<const copyable_from_const_lvalue_only &> o1 = cm;
    ASSERT_TRUE(o1);

    {
        retro::Optional<copyable_from_const_lvalue_only> o2 = o1;
        ASSERT_TRUE(o2);
    }

    retro::Optional<copyable_from_const_lvalue_only> o2 = std::move(o1);
    ASSERT_TRUE(o2);
...
{
    using retro::tests::copyable_from_const_lvalue_only;
    using retro::tests::explicitly_convertible_from_const_lvalue_only;

    explicitly_convertible_from_const_lvalue_only ec;

    retro::Optional<const explicitly_convertible_from_const_lvalue_only &> o3 = ec;

    retro::Optional<copyable_from_const_lvalue_only> o4(o3);
    ASSERT_TRUE(o4);
    retro::Optional<copyable_from_const_lvalue_only> o5(std::move(o3));
    ASSERT_TRUE(o5);
}
#endif
...
{
    retro::Optional<std::any> o1 = 42;

    retro::Optional<std::any> o2 = o1;
    EXPECT_TRUE(std::any_cast<const int &>(*o2) == 42);

    retro::Optional<std::any> o3 = std::move(o1);
