...
namespace retro
{
    ...
    {
    public:
        inline RenderPipeline(const vk::Device device, const VulkanSwapchain& swapchain, const vk::RenderPass render_pass) : pipeline_layout_{create_pipeline_layout(device)}, graphics_pipeline_{create_graphics_pipeline(device, pipeline_layout_.get(), swapchain, render_pass)}
        {
        }
    ...
    private:
        ...
        static vk::UniquePipeline create_graphics_pipeline(vk::Device device, vk::PipelineLayout layout, const VulkanSwapchain &swapchain, vk::RenderPass render_pass);
