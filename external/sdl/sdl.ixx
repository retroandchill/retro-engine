...
export namespace sdl
{
    ...
    enum class IOStatus
    {
        ...
        NOT_READY = SDL_IO_STATUS_NOT_READY,
    ...
    SDL_PixelFormat GetPixelFormatForMasks(int bpp, Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
    {
    ...
    enum class GLContextFlag : Uint32
    {
        ...
        FORWARD_COMPATIBLE_FLAG = SDL_GL_CONTEXT_FORWARD_COMPATIBLE_FLAG,
        ROBUST_ACCESS_FLAG = SDL_GL_CONTEXT_ROBUST_ACCESS_FLAG,
        RESET_ISOLATION_FLAG = SDL_GL_CONTEXT_RESET_ISOLATION_FLAG,
    };
    BITFLAG_ENUM(GLContextFlag);

    enum class GLContextReleaseFlag : Uint32
    {
        BEHAVIOR_NONE = SDL_GL_CONTEXT_RELEASE_BEHAVIOR_NONE,
        BEHAVIOR_FLUSH = SDL_GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH,
    };
    BITFLAG_ENUM(GLContextReleaseFlag);

    enum class GLContextResetNotification : Uint32
    {
        NOTIFICATION = SDL_GL_CONTEXT_RESET_NO_NOTIFICATION,
    ...
    SDL_GamepadButtonLabel GetGamepadButtonLabelForType(GamepadType type, GamepadButton button)
    {
    ...
    SDL_Keycode GetKeyFromScancode(Scancode scancode, Keymod modstate, bool key_event)
    {
    ...
    enum class TextInputType
    {
        ...
        TEXT_NAME = SDL_TEXTINPUT_TYPE_TEXT_NAME,
        TEXT_EMAIL = SDL_TEXTINPUT_TYPE_TEXT_EMAIL,
        TEXT_USERNAME = SDL_TEXTINPUT_TYPE_TEXT_USERNAME,
        TEXT_PASSWORD_HIDDEN = SDL_TEXTINPUT_TYPE_TEXT_PASSWORD_HIDDEN,
        TEXT_PASSWORD_VISIBLE = SDL_TEXTINPUT_TYPE_TEXT_PASSWORD_VISIBLE,
        NUMBER = SDL_TEXTINPUT_TYPE_NUMBER,
        NUMBER_PASSWORD_HIDDEN = SDL_TEXTINPUT_TYPE_NUMBER_PASSWORD_HIDDEN,
        NUMBER_PASSWORD_VISIBLE = SDL_TEXTINPUT_TYPE_NUMBER_PASSWORD_VISIBLE,
    };
    ...
    enum class GPUStoreOp
    {
        ...
        RESOLVE_AND_STORE = SDL_GPU_STOREOP_RESOLVE_AND_STORE,
    };
    REGULAR_ENUM(GPUStoreOp);

    enum class GPUIndexElementSize
    {
        _16BIT = SDL_GPU_INDEXELEMENTSIZE_16BIT,
        _32BIT = SDL_GPU_INDEXELEMENTSIZE_32BIT,
    };
    ...
    {
        _2D = SDL_GPU_TEXTURETYPE_2D,
        _2D_ARRAY = SDL_GPU_TEXTURETYPE_2D_ARRAY,
        _3D = SDL_GPU_TEXTURETYPE_3D,
    ...
    enum class GPUSwapchainComposition
    {
        ...
        HDR10_ST2084 = SDL_GPU_SWAPCHAINCOMPOSITION_HDR10_ST2084,
    };
    ...
    {
        RETURNKEY_DEFAULT = SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT,
    ...
    bool SetLinuxThreadPriorityAndPolicy(Sint64 threadID, int sdlPriority, int schedPolicy)
    {
        return SDL_SetLinuxThreadPriorityAndPolicy(threadID, sdlPriority, schedPolicy);
    }
#endif
    ...
    {
        YYYYMMDD = SDL_DATE_FORMAT_YYYYMMDD,
        DDMMYYYY = SDL_DATE_FORMAT_DDMMYYYY,
        MMDDYYYY = SDL_DATE_FORMAT_MMDDYYYY,
    };
    REGULAR_ENUM(DateFormat);

    enum class TimeFormat
    {
        _24HR = SDL_TIME_FORMAT_24HR,
        _12HR = SDL_TIME_FORMAT_12HR,
    };
...
export namespace sdl::vulkan
{
    ...
    bool GetPresentationSupport(VkInstance instance, VkPhysicalDevice physicalDevice, Uint32 queueFamilyIndex)
    {
